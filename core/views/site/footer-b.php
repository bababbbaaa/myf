...
<footer class="footer animate">
                <div class="container">
                    <div class="footer_top">
                        <div class="footer_top_left">
                            <a target="_blank" class="footer_top-links" href="https://www.myforce.ru/about">Узнать больше о проекте</a>
                            <a target="_blank" class="footer_top-links" href="https://www.myforce.ru/#partners">Партнеры проекта</a>
                        </div>
                        <div class="footer_top_rigth">
                            <img src="<?= Url::to(['img/quiz-bussiness/MYForce.svg']) ?>" alt="MYFORCE">
                    ...
                    <div class="footer_bottom">
                        <div class="footer_bottom_left">
                            ...
                            <a target="_blank" class="footer_bottom-link" href="/policy.html">Политика обработки персональных данных</a>
                        </div>
                        <div class="footer_bottom_right">
                            <a class="footer_bottom-right-phone" href="tel:+7 495 118 39 34">+7 495 118 39 34</a>
                            <a target="_blank" class="footer_bottom-link" href="/policy.pdf?v=16">*отправляя формы на данном сайте, вы даете согласие на обработку персональных данных в соответствии с 152-ФЗ</a>
                        </div>
                    </div>
                </div>
            </footer>
        ...
        <?php include_once('quiz-b.php')?>

        <div class="back"></div>
        <div class="popup-wrap">
            <section class="popup">
                <button class="btn btn-popup-close">
                    <img src="<?= Url::to(['img/quiz-bussiness/close.svg']) ?>" alt="close">
                </button>
                ...
                <div class="popup_staps popup_stap1">
                    ...
                    <p class="popup-description">*отправляя формы на данном сайте, вы даете согласие на обработку
                        персональных данных в соответствии с 152-ФЗ</p>
                    <?= Html::endForm(); ?>
                </div>

                <div class="popup_staps popup_stap2">
                    <h2 class="popup-title">Спасибо за вашу заявку, <br> в скором времени мы свяжемся с вами</h2>
                    <h3 class="popup-under-title">Пока Вы ожидаете звонка нашего специалиста, узнайте больше о продуктах нашей компании</h3>
                    <a target="_blank" href="https://www.myforce.ru/about" class="btn link-btn"><p>Узнать больше</p></a>
                </div>
            </section>
        </div>

<script src="<?= Url::to(['js/quiz-bussiness/jquery-3.5.1.min.js']) ?>"></script>
<script type="text/javascript" src="<?= Url::to(['js/quiz-bussiness/jquery.maskedinput.js']) ?>"></script>
<script src="<?= Url::to(['js/quiz-bussiness/script.js']) ?>"></script>
    </body>
</HTML>