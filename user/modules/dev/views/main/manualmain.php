...
<section class="rightInfo">
    ...
    <section class="usermanualmain_info">
        <div class="usermanualmain_info_row">
            <img src="<?= Url::to(['/img/dev/main-1.png']) ?>" alt="скриншот страницы">
            <div class="usermanualmain_info_row_right">
                ...
                <p class="usermanualmain_info_row_right-text">
                    После регистрации на сайте вы попадаете на стартовую страницу. Здесь вы можете найти основную информацию о балансе, транзакциях, проектах.
                </p>
            </div>
        </div>
        <div class="usermanualmain_info_column-wrapp">
            ...
            <div class="usermanualmain_info_column">
                ...
                <img src="<?= Url::to(['/img/dev/main-2.png']) ?>" alt="скриншот страницы">
            </div>
            ...
            <div class="usermanualmain_info_column">
                ...
                <img src="<?= Url::to(['/img/dev/main-3.png']) ?>" alt="скриншот страницы">
            </div>
        </div>
    </section>
