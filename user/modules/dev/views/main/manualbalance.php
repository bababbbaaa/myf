...
<section class="rightInfo">
    ...
    <section class="usermanualmain_info">
        <div class="usermanualmain_info_row">
            <img src="<?= Url::to(['/img/dev/balance-1.png']) ?>" alt="скриншот страницы">
        ...
        <div class="usermanualmain_info_column-wrapp">
            ...
            <div class="usermanualmain_info_column">
                ...
                <img src="<?= Url::to(['/img/dev/balance-2.png']) ?>" alt="скриншот страницы">
            </div>
            <div class="usermanualmain_info_row">
                <div class="usermanualmain_info_row_right">
                    <p class="usermanualmain_info_row_right-text">
                ...
                <img src="<?= Url::to(['/img/dev/balance-3.png']) ?>" alt="скриншот страницы">
            </div>
            <p class="usermanualmain_info_column-text">
            ...
            <img src="<?= Url::to(['/img/dev/balance-4.png']) ?>" alt="скриншот страницы">
            <div class="usermanualmain_info_column">
                <h3 class="usermanualmain_info_column-title">
                2. При оплате счета
                </h3>
                ...
                <img src="<?= Url::to(['/img/dev/balance-5.png']) ?>" alt="скриншот страницы">
            </div>
            <div class="usermanualmain_info_row">
                <div class="usermanualmain_info_row_right">
                    <p class="usermanualmain_info_row_right-text">
                ...
                <img src="<?= Url::to(['/img/dev/balance-6.png']) ?>" alt="скриншот страницы">
            </div>
            <p class="usermanualmain_info_column-text">
            ...
            <img src="<?= Url::to(['/img/dev/balance-7.png']) ?>" alt="скриншот страницы">
        </div>
    </section>
