    ...
    <div class="balance">
        ...
        <article class="MainInfo">
            <nav class="ChangePageBalance df">
                ...
                <div class="ChangePage-Item df jcsb aic">
                    <a href="#page3" class="HText ChangePage-Item-t ChangePage-Item-t2 uscp">Счета</a>
                    <div class="ChangePage-Item-line ChangePage-Item-line3"></div>
                </div>
                <div class="ChangePage-Item df jcsb aic">
                    <a href="#page4" class="HText ChangePage-Item-t ChangePage-Item-t2 uscp">Акты выполненных работ</a>
                    ...
                    <div class="PopapDBC">
                        ...
                        <div class="PopapDBC-Cont df fdc aic">
                            ...
                            <div class="PopapDBC-Form df fdc">
                                ...
                                <input id="inpDonAmm" class="InputDonateAmount" required placeholder="Минимальная сумма пополнения 5 000₽" type="number" min="5000" name="DonateAmount" id="">
