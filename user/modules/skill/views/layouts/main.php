...
<section style="position: relative">
    <?php $this->beginBody() ?>
    <?php if (Yii::$app->controller->action->id !== 'mycours' && Yii::$app->controller->action->id !== 'lesson' && Yii::$app->controller->action->id !== 'test' && Yii::$app->controller->action->id !== 'coursepage' && Yii::$app->controller->action->id !== 'intensivpage'): ?>
