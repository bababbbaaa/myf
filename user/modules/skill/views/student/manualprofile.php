...
<section class="rightInfo">
  ...
  <section class="usermanualmain_info">
    <div class="usermanualmain_info_row">
      <img src="<?= Url::to(['/img/skillclient/profile-1.png']) ?>" alt="скриншот страницы">
    ...
    <div class="usermanualmain_info_column-wrapp">
      ...
      <div class="usermanualmain_info_column">
        ...
        <img src="<?= Url::to(['/img/skillclient/profile-2.png']) ?>" alt="скриншот страницы">
      </div>
      <div class="usermanualmain_info_column">
        <p class="usermanualmain_info_column-text">
        Далее вам нужно выбрать в качестве какого лица вы регистрируетесь в личном кабинете — физического или юридического, и заполнить все поля. Данный выбор влияет на способ оплаты за программы обучения.
        </p>
        <img src="<?= Url::to(['/img/skillclient/profile-3.png']) ?>" alt="скриншот страницы">
      </div>
      <div class="usermanualmain_info_column">
        <p class="usermanualmain_info_column-text">
        Не забудьте сохранить изменения!
        </p>
        <img src="<?= Url::to(['/img/skillclient/profile-4.png']) ?>" alt="скриншот страницы">
      </div>
      <div class="usermanualmain_info_column">
        <h3 class="usermanualmain_info_column-title">
        ...
        <p class="usermanualmain_info_column-text">
        В этом пункте вы можете выбрать, как хотите пополнять баланс — как юридическое лицо или как физическое, либо обоими способами сразу.
        <br>
        Выберите вид плательщика, заполните поля и сохраните данные.
        </p>
        <img src="<?= Url::to(['/img/skillclient/profile-5.png']) ?>" alt="скриншот страницы">
      </div>
      <div class="usermanualmain_info_column">
        <p class="usermanualmain_info_column-text">
        ...
        <img src="<?= Url::to(['/img/skillclient/profile-6.png']) ?>" alt="скриншот страницы">
      </div>
      <div class="usermanualmain_info_column">
        <h3 class="usermanualmain_info_column-title">
          3. Сменить пароль
        ...
        <img src="<?= Url::to(['/img/skillclient/profile-7.png']) ?>" alt="скриншот страницы">
      </div>
      <div class="usermanualmain_info_column">
        <h3 class="usermanualmain_info_column-title">
          4. Уведомления
        ...
        <img src="<?= Url::to(['/img/skillclient/profile-8.png']) ?>" alt="скриншот страницы">
      </div>
    </div>
  </section>
