              ...
              <div class="not">
                <div class="not__inner">
                  <div class="not__item">
                    ...
                    <input id="not-email-1" <?= $prop['status'] == 1 ? 'checked' : '' ?> class="not__chek prof__checkbox-inp" value="Окончание средств на балансе" type="checkbox" name="propertis[balance]" />
                    <label for="not-email-1" class="not__chek prof__checkbox">
                    Окончание средств на балансе
                    </label>

                    <input id="not-email-2" <?= $prop['email'] == 1 ? 'checked' : '' ?> class="not__chek prof__checkbox-inp" value="Новости" type="checkbox" name="propertis[news]" />
                    <label for="not-email-2" class="not__chek prof__checkbox">
                      Новости
                    </label>

                    <input id="not-email-3" <?= $prop['status'] == 1 ? 'checked' : '' ?> class="not__chek prof__checkbox-inp" value="Уведомления о проверенных заданиях" type="checkbox" name="propertis[verified_tasks]" />
                    <label for="not-email-3" class="not__chek prof__checkbox">
                    Уведомления о проверенных заданиях
                    </label>

                    <input id="not-email-4" <?= $prop['status'] == 1 ? 'checked' : '' ?> class="not__chek prof__checkbox-inp" value="Уведомления о предстоящих вебинарах" type="checkbox" name="propertis[webinars]" />
                    <label for="not-email-4" class="not__chek prof__checkbox">
                    Уведомления о предстоящих вебинарах
                    </label>

                    <input id="not-email-5" <?= $prop['balance'] == 1 ? 'checked' : '' ?> class="not__chek prof__checkbox-inp" value="Уведомления о доступе к новым блокам курса" type="checkbox" name="propertis[course]" />
                  ...
                  <div class="not__item">
                    ...
                    <input id="not-push-2" <?= $prop['push_status'] == 1 ? 'checked' : '' ?> class="not__chek prof__checkbox-inp" value="Уведомления о новых акциях и скидках" type="checkbox" name="propertis[push_status]" />
                    <label for="not-push-2" class="not__chek prof__checkbox">
                    Уведомления о новых акциях и скидках
                    </label>

                    <input id="not-push-3" <?= $prop['new_lead'] == 1 ? 'checked' : '' ?> class="not__chek prof__checkbox-inp" value="Уведомления о проверенных заданиях" type="checkbox" name="propertis[verified_tasks]" />
                    <label for="not-push-3" class="not__chek prof__checkbox">
                    Уведомления о проверенных заданиях
                    </label>

                    <input id="not-push-4" <?= $prop['proposition'] == 1 ? 'checked' : '' ?> class="not__chek prof__checkbox-inp" value="Уведомления о предстоящих вебинарах" type="checkbox" name="propertis[webinars]" />
                    <label for="not-push-4" class="not__chek prof__checkbox">
                    Уведомления о предстоящих вебинарах
                    </label>

                    <input id="not-push-5" <?= $prop['push_status'] == 1 ? 'checked' : '' ?> class="not__chek prof__checkbox-inp" value="Уведомления о доступе к новым блокам курса" type="checkbox" name="propertis[course]" />
