...
$js = <<< JS
    ...
    $('.popup__btn1').on('click', function (e) {
        e.preventDefault();
        $.ajax({
            url: '/skill/teacher/profile-saver',
    ...
    $('.send__pay-fiz').on('click', function(e) {
        e.preventDefault();
        $.ajax({
          url: '/skill/teacher/info-payment',
...
<section class="rightInfo">
    <div class="cab__wrapp">
        <div class="prof__main">
            ...
            <h2 class="prof__title title-main">
                Профиль
            </h2>
                ...
                <div class="mass mass--cab">
                    <div class="mass__content mass__content--cab">
                        <p class="mass__text mass__text--prof">
                            Пожалуйста, заполните ваши данные, чтобы получить доступ к выводу средств
                        </p>
            ...
            <div class="prof__inner">
                <div class="prof__box">
                    <div class="prof__nav">
                        <div class="prof__nav--fix">
                            <a href="#item1" class="prof__nav-li active">Ваши данные</a>
                            <?php Pjax::begin(['id' => 'PjaxShow']) ?>
                            <?php if (!empty($client)): ?>
                                <a href="#item2" class="prof__nav-li">Информация для выплат</a>
                            <?php endif; ?>
                            <?php Pjax::end() ?>
                            ...
                            <div class="prof__item-inner">
                                ...
                                <label class="prof__label">
                                    ...
                                    <input class="prof__inp1 readonly__class" <?= !empty($client) ? 'readonly' : '' ?>
                                           type="text"
                                           name="fields[familiya]" value="<?= $client['f'] ?? '' ?>"
                                           placeholder="Фамилия">
                                </label>
                                <label class="prof__label">
                                ...
                                <?php if (!empty($model)): ?>
                                    <label class="prof__label">
                                        ...
                                        <input style="user-select: none" class="prof__inp1 readonly__class" readonly
                                               type="text"
                                               name="fields[phone]" value="<?= $model['username'] ?>"
                                               placeholder="Телефон">
                                    </label>
                                <?php endif; ?>
                                <label class="prof__label">
                                                ...
                                                <div class="prof__item-row">
                                                    <label class="prof__item-label">
                                                        ...
                                                        <input <?= $company ? 'readonly' : '' ?>
                                                                ...
                                                                data-type="rec"
                                                                type="text" name="fields[jur][companyName]"
                                                    ...
                                                    <label class="prof__item-label">
                                                        ...
                                                        <input <?= $company ? 'readonly' : '' ?>
                                                                ...
                                                                class="prof__inp1 readonly__class prof__inp1--w"
                                                                data-type="rec"
                                                                type="text" name="fields[jur][address_jur]"
                                                ...
                                                <div class="prof__item-row">
                                                    <label class="prof__item-label">
                                                        ...
                                                        <input <?= $company ? 'readonly' : '' ?>
                                                                ...
                                                                class="prof__inp1 readonly__class prof__inp1--w"
                                                                type="text"
                                                                data-type="rec" name="fields[jur][director]"
                                                ...
                                                <div class="prof__form">
                                                    <label class="prof__label">
                                                        ...
                                                        <input <?= $company ? 'readonly' : '' ?>
                                                                ...
                                                                class="prof__inp1 readonly__class"
                                                                type="text" name="fields[jur][web_site]"
                                            ...
                                            <div class="prof__item-wrap">
                                                <label class="prof__item-label prof__item-label--1">
                                                  <span class="prof__span readonly__class prof__span--2 prof__span--rec">Адрес регистрации по
                                                    ...
                                                    <input <?= $fiz ? 'readonly' : '' ?>
                                                            value="<?= $fiz->address ?>"
                                                            class="prof__inp1 readonly__class prof__inp1--w" type="text"
                                        ...
                                        <div class="prof__item-box prof__item-box--1 active box1">
                                            ...
                                            <div class="prof__add">
                                                ...
                                                <div class="prof__form">
                                                    <label class="prof__label">
                                                        <span class="prof__span">Веб-сайт компании</span>
                                                        <input class="prof__inp1 readonly__class"
                                                               type="text" name="fields[jur][web_site]"
                                                               placeholder="Веб-сайт компании">
                                                    </label>
                                                    ...
                                                    <div class="prof__form">
                                                        <label class="prof__label">
                                                            ...
                                                            <input value="<?= $company->companyName ?>"
                                                                   class="prof__inp1" type="text" name="info[jur][organization]"
                                                                   placeholder="ООО 'Праватон'">
                                                        </label>

                                                        <label class="prof__label">
                                                            <span class="prof__span">Генеральный директор</span>
                                                            <input value="<?= $company->director ?>"
                                                                   class="prof__inp1" type="text" name="info[jur][director]"
                                                                   placeholder="Иван Иванов">
                                                        </label>

                                                        <label class="prof__label">
                                                            <span class="prof__span">Юридический адрес</span>
                                                            <input value="<?= $company->address_jur ?>"
                                                                   class="prof__inp1" type="text" name="info[jur][jur_address]"
                                                                   placeholder="Юридический адрес">
                                                        </label>

                                                        <label class="prof__label">
                                                            <span class="prof__span">Фактический адрес</span>
                                                            <input value="<?= $company->address_real ?>"
                                                                   class="prof__inp1" type="text" name="info[jur][real_address]"
                                            ...
                                            <div id="box4" class="prof__item-box prof__item-box--2 box4">
                                                <div class="prof__item-inner">
                                                    ...
                                                    <div class="prof__form">
                                                        ...
                                                        <label class="prof__label">
                                                            <span class="prof__span">Номер карты/счета (кошелька)</span>
                                                            <input
                                                                    class="prof__inp1 resetInp" data-value="form5-5"
                                                                    value=""
                                                                    type="text" name="info[fiz][card]"
                                                                    placeholder="4274 2777 1111 0000">
                                                        </label>
                                                    </div>
                                                </div>
                                            ...
                                            <div id="box5" class="prof__item-box2 prof__item-box2--2 active">
                                                <div class="prof__item-inner">
                                                    ...
                                                    <div class="prof__form">
                                                        ...
                                                        <label class="prof__label">
                                                            <span class="prof__span">Номер карты/счета (кошелька)</span>
                                                            <input <?= !empty($infoPay['fiz']['card']) ? 'readonly' : '' ?>
                                                                    class="prof__inp1 resetInp" data-value="form5-5"
                                                                    value="<?= $infoPay['fiz']['card'] ?? '' ?>"
                                                                    type="text" name="info[fiz][card]"
                                                                    placeholder="4274 2777 1111 0000">
                                                        </label>
                                                    </div>
                            ...
                            <div class="not">
                                <div class="not__inner">
                                    <div class="not__item">
                                        ...
                                        <input id="not-email-1" <?= $prop['email'] == 1 ? 'checked' : '' ?> class="not__chek prof__checkbox-inp" value="Новости"
                                               type="checkbox" name="propertis[email]"/>
                                        <label for="not-email-1" class="not__chek prof__checkbox">
                                            Новости
                                        </label>

                                        <input id="not-email-2" <?= $prop['status'] == 1 ? 'checked' : '' ?> class="not__chek prof__checkbox-inp"
                                               value="Изменение статуса заказа" type="checkbox"
                                               name="propertis[status]"/>
                                        <label for="not-email-2" class="not__chek prof__checkbox">
                                            Изменение статуса заказа
                                        </label>

                                        <input id="not-email-3" <?= $prop['balance'] == 1 ? 'checked' : '' ?> class="not__chek prof__checkbox-inp"
                                               value="Окончание средств на балансе" type="checkbox"
                                               name="propertis[balance]"/>
                                    ...
                                    <div class="not__item">
                                        ...
                                        <input id="not-push-1" <?= $prop['push'] == 1 ? 'checked' : '' ?> class="not__chek prof__checkbox-inp" value="Новости"
                                               type="checkbox" name="propertis[push]"/>
                                        <label for="not-push-1" class="not__chek prof__checkbox">
                                            Новости
                                        </label>

                                        <input id="not-push-2" <?= $prop['push_status'] == 1 ? 'checked' : '' ?> class="not__chek prof__checkbox-inp"
                                               value="Изменение статуса заказа" type="checkbox"
                                        ...
                                        <input id="not-push-3" <?= $prop['new_lead'] == 1 ? 'checked' : '' ?> class="not__chek prof__checkbox-inp"
                                               value="Новые лиды" type="checkbox" name="propertis[new_lead]"/>
                                        <label for="not-push-3" class="not__chek prof__checkbox">
                                            Новые лиды
                                        </label>

                                        <input id="not-push-4" <?= $prop['proposition'] == 1 ? 'checked' : '' ?> class="not__chek prof__checkbox-inp"
                                               value="Новые предложения лидов" type="checkbox" name="propertis[proposition]"/>
                ...
                <div class="popup__content popup__content--w">
                    ...
                    <p class="popup__text">
                        Сохраненные данные можно редактировать только через обращение в <a
                                href="<?= Url::to(['support']) ?>" class="link">тех.поддержку</a>
                    </p>
