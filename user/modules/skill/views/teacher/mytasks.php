...
<section class="rightInfo">
    <div class="bcr">
        <ul class="bcr__list">
            ...
            <li class="bcr__item">
                <span class="bcr__span nowpagebrc">Проверяю я</span>
            </li>
        </ul>
    </div>
    <div class="title_row">
        <h1 class="Bal-ttl title-main">Мои задания</h1>
        <a href="<?= Url::to(['']) ?>" class="link--purple">Что такое мои задания?</a>
    </div>

    <nav class="ChangePageBalance df mytasks">
        <div class="ChangePage-Item df jcsb aic">
            <a href="#page1" class="HText ChangePage-Item-t ChangePage-Item-t1 uscp CIT-active">Проверяю я</a>
            <div class="ChangePage-Item-line ChangePage-Item-line1 CIL-active"></div>
        </div>
        <div class="ChangePage-Item df jcsb aic">
            <a href="#page2" class="HText ChangePage-Item-t ChangePage-Item-t2 uscp">Ассистенты</a>
    ...
    <article class="mytasks_main">
        ...
        <section class="mytasks_main-filter">
            <label class="MyOrders_filter-check-l sendActive programs-filter-submit">Нужно проверить
                <input class="MyOrders_filter-check" type="checkbox" name="choice" value="Нужно проверить">
            </label>
            <label class="MyOrders_filter-check-l sendActive programs-filter-submit active">Все задания
            ...
            <div class="mytask_page-inner">
                <div class="mytask_page-body">
                    <article class="mytask_item">
                        <a href="<?= Url::to(['taskpage']) ?>" class="mytask_item-link"></a>
                        <div class="mytask_item-content">
                            ...
                            <a href="<?= Url::to(['taskpage']) ?>" class="mytask_item-check-link">Перейти к проверке</a>
                        </div>
                    </article>
        ...
        <section class="mytasks_main-page mytasks_main-page-2">
            <div class="mytask_page-inner">
                <div class="mytask_page-body">
                    <article class="mytask_item">
                        <a href="<?= Url::to(['taskpage-assistent']) ?>" class="mytask_item-link"></a>
                        <div class="mytask_item-content">
                            <date class="mytask_item-date">До 20.09.2021</date>
                            <p class="mytask_item-subtitle">интенсив “Менеджер продаж”</p>
                            <h2 class="mytask_item-title">10.4 Задание</h2>
                            ...
                            <div class="mytask_item-check">
                                ...
                                <div class="mytask_item-block">
                                    <p class="mytask_item-check-text">Проверяет</p>
                                    <p class="mytask_item-check-num">Марина Дьярова</p>
                                </div>
                            </div>
                            <a href="<?= Url::to(['']) ?>" class="mytask_item-check-link">Подробнее</a>
                        </div>
                    </article>
                ...
                <div class="mytask_page-aside">
                    <div class="mytask_page-sorting">
                        ...
                        <?= Html::beginForm('', 'get', ['class' => 'mytask_page-sorting-form']) ?>
                        <div class="mytask_page-sorting-body">
                            <input id="curs-market1" class="mytask_page-sorting-item-check sr-only" type="checkbox" name="type[]" value="курс Маркетинг">
                            <label for="curs-market1" class="mytask_page-sorting-item">
                                <p class="mytask_page-sorting-item-subtitle">курс</p>
                                <p class="mytask_page-sorting-item-title">Маркетинг</p>
                            </label>

                            <input id="intensive-market1" class="mytask_page-sorting-item-check sr-only" type="checkbox" name="type[]" value="интенсив Маркетинг">
                            <label for="intensive-market1" class="mytask_page-sorting-item">
                                <p class="mytask_page-sorting-item-subtitle">интенсив</p>
                                <p class="mytask_page-sorting-item-title">Маркетинг</p>
                            </label>

                            <input id="intensive-manager1" class="mytask_page-sorting-item-check sr-only" type="checkbox" name="type[]" value="интенсив Менеджер продаж">
                            <label for="intensive-manager1" class="mytask_page-sorting-item">
                                <p class="mytask_page-sorting-item-subtitle">интенсив</p>
                                <p class="mytask_page-sorting-item-title">Менеджер продаж</p>
                            </label>
                        </div>
                    ...
                    <div class="mytask_page-sorting">
                        <h3 class="mytask_page-sorting-title">
                            Сортировать по ассистентам
                        </h3>
                        <?= Html::beginForm('', 'get', ['class' => 'mytask_page-sorting-form']) ?>
                        <div class="mytask_page-sorting-inner">
                            <input id="MD" class="mytask_page-sorting-item-check sr-only" type="checkbox" name="type[]" value="Марина Дьярова">
                            <label for="MD" class="mytask_page-sorting-avatar">
                                <div class="mytask_page-sorting-img">
                                    <img src="<?= Url::to(['']) ?>" alt="photo" />
                                </div>
                                <p class="mytask_page-sorting-item-name">Марина Дьярова</p>
                            </label>

                            <input id="II" class="mytask_page-sorting-item-check sr-only" type="checkbox" name="type[]" value="Ирина Ивановская">
                            <label for="II" class="mytask_page-sorting-avatar">
                                <div class="mytask_page-sorting-img">
                                    <img src="<?= Url::to(['']) ?>" alt="photo" />
                                </div>
                                <p class="mytask_page-sorting-item-name">Ирина Ивановская</p>
                            </label>

                            <input id="OK" class="mytask_page-sorting-item-check sr-only" type="checkbox" name="type[]" value="Олег Красильников">
                            <label for="OK" class="mytask_page-sorting-avatar">
                                <div class="mytask_page-sorting-img">
                                    <img src="<?= Url::to(['']) ?>" alt="photo" />
                                </div>
                                <p class="mytask_page-sorting-item-name">Олег Красильников</p>
                            </label>

                            <input id="II2" class="mytask_page-sorting-item-check sr-only" type="checkbox" name="type[]" value="Ирина Ивановск">
                            <label for="II2" class="mytask_page-sorting-avatar">
                                <div class="mytask_page-sorting-img">
                                    <img src="<?= Url::to(['']) ?>" alt="photo" />
                                </div>
                                <p class="mytask_page-sorting-item-name">Ирина Ивановская</p>
                            ...
                            <input id="II1" class="mytask_page-sorting-item-check sr-only" type="checkbox" name="type[]" value="Ирина Ивановск">
                            <label for="II1" class="mytask_page-sorting-avatar">
                                <div class="mytask_page-sorting-img">
                                    <img src="<?= Url::to(['']) ?>" alt="photo" />
                                </div>
                                <p class="mytask_page-sorting-item-name">Ирина Ивановская</p>
