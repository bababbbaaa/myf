...
$('select[name="autowebinar-date-reliase"]').on('change', function(){
    if($(this).val() == 'по расписанию'){
        $('.autowebinar-days-type_gr-2').hide();
        $('.autowebinar-days-type_gr-1').show();
    }else if($(this).val() == 'в указанные даты'){
        $('.autowebinar-days-type_gr-1').hide();
        $('.autowebinar-days-type_gr-2').show();
    }
});

$('.autowebinar-days-type_gr-2-btn').on('click', function(){
    $('.autowebinar-date-inputs-rows-g').append('<div class="webinar-date-inputs-row"><input class="input-date-t input-date-date" type="date" name="autowebinar-date"><input class="input-date-t input-date-time" type="time" name="webinar-time"></div>');
});

$('.create-resume-form_main').on('click', ".autowebinar_last-Stap_group-item-btn-delete", function(){
    $(this).parent().parent().remove();
});

$('.create-resume-form_main').on('click', ".autowebinar_last-Stap_group-item-btn", function(){
    $(this).toggleClass('active');
    $(this).parent().next().toggleClass('active');
});

$('.autowebinar-btn--add-script').on('click', function(){
    if($('select[name="autowebinar-event-type"]').val() == 'Презентация'){
        $('.autowebinar_last-Stap_group-2').append('<div class="autowebinar_last-Stap_group-item"><div class="autowebinar_last-Stap_group-item-top"><input value="00:00" class="input-date-t input-date-time input-date-time-sh input-date-time-bn" type="time" name="autowebinar-time"><button type="button" class="autowebinar_last-Stap_group-item-btn"><span class="autowebinar_last-Stap_group-item-start-t">Показ презентации</span><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M6.06564 7.68306C5.82156 7.43898 5.42583 7.43898 5.18176 7.68306C4.93768 7.92714 4.93768 8.32286 5.18176 8.56694L9.34842 12.7336C9.5925 12.9777 9.98823 12.9777 10.2323 12.7336L14.399 8.56694C14.6431 8.32286 14.6431 7.92714 14.399 7.68306C14.1549 7.43898 13.7592 7.43898 13.5151 7.68306L9.79036 11.4078L6.06564 7.68306Z" fill="#A5AABE"/></svg></button><button type="button" class="autowebinar_last-Stap_group-item-btn-delete"><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M13.0801 6.00026L4.92035 6.00004L4.49536 6.00003C3.89825 6.00001 3.4342 6.51989 3.50175 7.11317L4.34259 14.4975C4.40377 15.0504 4.66757 15.561 5.08308 15.9308C5.49859 16.3006 6.03636 16.5034 6.59259 16.5H11.4076C11.9638 16.5034 12.5016 16.3006 12.9171 15.9308C13.3326 15.561 13.5964 15.0504 13.6576 14.4975L14.4983 7.11331C14.5658 6.51998 14.1017 6.00009 13.5045 6.00019L13.0801 6.00026ZM12.1501 14.3325C12.1297 14.5168 12.0418 14.687 11.9033 14.8103C11.7648 14.9336 11.5855 15.0012 11.4001 15H6.59259C6.40718 15.0012 6.22793 14.9336 6.08942 14.8103C5.95092 14.687 5.86299 14.5168 5.84259 14.3325L5.08509 7.50004H12.9151L12.1501 14.3325ZM10.5001 13.5C10.699 13.5 10.8898 13.421 11.0304 13.2804C11.1711 13.1397 11.2501 12.949 11.2501 12.75V9.75004C11.2501 9.55113 11.1711 9.36036 11.0304 9.21971C10.8898 9.07906 10.699 9.00004 10.5001 9.00004C10.3012 9.00004 10.1104 9.07906 9.96977 9.21971C9.82911 9.36036 9.7501 9.55113 9.7501 9.75004V12.75C9.7501 12.949 9.82911 13.1397 9.96977 13.2804C10.1104 13.421 10.3012 13.5 10.5001 13.5ZM7.50009 13.5C7.69901 13.5 7.88977 13.421 8.03042 13.2804C8.17108 13.1397 8.25009 12.949 8.25009 12.75V9.75004C8.25009 9.55113 8.17108 9.36036 8.03042 9.21971C7.88977 9.07906 7.69901 9.00004 7.50009 9.00004C7.30118 9.00004 7.11042 9.07906 6.96976 9.21971C6.82911 9.36036 6.75009 9.55113 6.75009 9.75004V12.75C6.75009 12.949 6.82911 13.1397 6.96976 13.2804C7.11042 13.421 7.30118 13.5 7.50009 13.5Z" fill="#A5AABE"/><rect x="2.625" y="4.125" width="12.75" height="0.75" rx="0.375" stroke="#A5AABE" stroke-width="0.75"/><path d="M12 3.75V2.5C12 1.94772 11.5523 1.5 11 1.5H7C6.44772 1.5 6 1.94772 6 2.5V3.75" stroke="#A5AABE" stroke-width="2"/></svg></button></div><div class="autowebinar_last-Stap_group-item-block"><div style="margin-bottom: 8px;" class="input__wrapper"><input name="webinar-presintation[]" type="file"  id="input__file-3-2" class="input input__file" multiple><label for="input__file-3-2" class="input__file-button"><span class="input__file-button-text">Загрузить презентацию</span></label></div><div class="autowebinar_last-Stap_group-item-block_row"><img src="" alt="без понятия шо за img"><input class="input-t autowebinar_last-Stap_group-item-block_row-input" type="number" name="number-slide"><p class="autowebinar_last-Stap_group-item-block-text">Укажите номер слайда</p></div></div></div>');
    }else if($('select[name="autowebinar-event-type"]').val() == 'Продающий блок'){
        $('.autowebinar_last-Stap_group-2').append('<div class="autowebinar_last-Stap_group-item"><div class="autowebinar_last-Stap_group-item-top"><input value="00:00" class="input-date-t input-date-time input-date-time-sh input-date-time-bn" type="time" name="autowebinar-time"><button type="button" class="autowebinar_last-Stap_group-item-btn"><span class="autowebinar_last-Stap_group-item-start-t">Продающий блок</span><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M6.06564 7.68306C5.82156 7.43898 5.42583 7.43898 5.18176 7.68306C4.93768 7.92714 4.93768 8.32286 5.18176 8.56694L9.34842 12.7336C9.5925 12.9777 9.98823 12.9777 10.2323 12.7336L14.399 8.56694C14.6431 8.32286 14.6431 7.92714 14.399 7.68306C14.1549 7.43898 13.7592 7.43898 13.5151 7.68306L9.79036 11.4078L6.06564 7.68306Z" fill="#A5AABE"/></svg></button><button type="button" class="autowebinar_last-Stap_group-item-btn-delete"><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M13.0801 6.00026L4.92035 6.00004L4.49536 6.00003C3.89825 6.00001 3.4342 6.51989 3.50175 7.11317L4.34259 14.4975C4.40377 15.0504 4.66757 15.561 5.08308 15.9308C5.49859 16.3006 6.03636 16.5034 6.59259 16.5H11.4076C11.9638 16.5034 12.5016 16.3006 12.9171 15.9308C13.3326 15.561 13.5964 15.0504 13.6576 14.4975L14.4983 7.11331C14.5658 6.51998 14.1017 6.00009 13.5045 6.00019L13.0801 6.00026ZM12.1501 14.3325C12.1297 14.5168 12.0418 14.687 11.9033 14.8103C11.7648 14.9336 11.5855 15.0012 11.4001 15H6.59259C6.40718 15.0012 6.22793 14.9336 6.08942 14.8103C5.95092 14.687 5.86299 14.5168 5.84259 14.3325L5.08509 7.50004H12.9151L12.1501 14.3325ZM10.5001 13.5C10.699 13.5 10.8898 13.421 11.0304 13.2804C11.1711 13.1397 11.2501 12.949 11.2501 12.75V9.75004C11.2501 9.55113 11.1711 9.36036 11.0304 9.21971C10.8898 9.07906 10.699 9.00004 10.5001 9.00004C10.3012 9.00004 10.1104 9.07906 9.96977 9.21971C9.82911 9.36036 9.7501 9.55113 9.7501 9.75004V12.75C9.7501 12.949 9.82911 13.1397 9.96977 13.2804C10.1104 13.421 10.3012 13.5 10.5001 13.5ZM7.50009 13.5C7.69901 13.5 7.88977 13.421 8.03042 13.2804C8.17108 13.1397 8.25009 12.949 8.25009 12.75V9.75004C8.25009 9.55113 8.17108 9.36036 8.03042 9.21971C7.88977 9.07906 7.69901 9.00004 7.50009 9.00004C7.30118 9.00004 7.11042 9.07906 6.96976 9.21971C6.82911 9.36036 6.75009 9.55113 6.75009 9.75004V12.75C6.75009 12.949 6.82911 13.1397 6.96976 13.2804C7.11042 13.421 7.30118 13.5 7.50009 13.5Z" fill="#A5AABE"/><rect x="2.625" y="4.125" width="12.75" height="0.75" rx="0.375" stroke="#A5AABE" stroke-width="0.75"/><path d="M12 3.75V2.5C12 1.94772 11.5523 1.5 11 1.5H7C6.44772 1.5 6 1.94772 6 2.5V3.75" stroke="#A5AABE" stroke-width="2"/></svg></button></div><div class="autowebinar_last-Stap_group-item-block"><p class="autowebinar_last-Stap_group-item-block-text">Выберите блок из созданных на предыдущем шаге</p><select class="autowebinar_last-Stap_group-item-block-select" name="autowebinar-blocks"><option selected value="Block1">Block1</option><option value="Block2">Block2</option></select></div></div>');
    }else if($('select[name="autowebinar-event-type"]').val() == 'Сообщение в чат'){
        $('.autowebinar_last-Stap_group-2').append('<div class="autowebinar_last-Stap_group-item"><div class="autowebinar_last-Stap_group-item-top"><input value="00:00" class="input-date-t input-date-time input-date-time-sh input-date-time-bn" type="time" name="autowebinar-time"><button type="button" class="autowebinar_last-Stap_group-item-btn"><span class="autowebinar_last-Stap_group-item-start-t">Сообщение в чат</span><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M6.06564 7.68306C5.82156 7.43898 5.42583 7.43898 5.18176 7.68306C4.93768 7.92714 4.93768 8.32286 5.18176 8.56694L9.34842 12.7336C9.5925 12.9777 9.98823 12.9777 10.2323 12.7336L14.399 8.56694C14.6431 8.32286 14.6431 7.92714 14.399 7.68306C14.1549 7.43898 13.7592 7.43898 13.5151 7.68306L9.79036 11.4078L6.06564 7.68306Z" fill="#A5AABE"/></svg></button><button type="button" class="autowebinar_last-Stap_group-item-btn-delete"><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M13.0801 6.00026L4.92035 6.00004L4.49536 6.00003C3.89825 6.00001 3.4342 6.51989 3.50175 7.11317L4.34259 14.4975C4.40377 15.0504 4.66757 15.561 5.08308 15.9308C5.49859 16.3006 6.03636 16.5034 6.59259 16.5H11.4076C11.9638 16.5034 12.5016 16.3006 12.9171 15.9308C13.3326 15.561 13.5964 15.0504 13.6576 14.4975L14.4983 7.11331C14.5658 6.51998 14.1017 6.00009 13.5045 6.00019L13.0801 6.00026ZM12.1501 14.3325C12.1297 14.5168 12.0418 14.687 11.9033 14.8103C11.7648 14.9336 11.5855 15.0012 11.4001 15H6.59259C6.40718 15.0012 6.22793 14.9336 6.08942 14.8103C5.95092 14.687 5.86299 14.5168 5.84259 14.3325L5.08509 7.50004H12.9151L12.1501 14.3325ZM10.5001 13.5C10.699 13.5 10.8898 13.421 11.0304 13.2804C11.1711 13.1397 11.2501 12.949 11.2501 12.75V9.75004C11.2501 9.55113 11.1711 9.36036 11.0304 9.21971C10.8898 9.07906 10.699 9.00004 10.5001 9.00004C10.3012 9.00004 10.1104 9.07906 9.96977 9.21971C9.82911 9.36036 9.7501 9.55113 9.7501 9.75004V12.75C9.7501 12.949 9.82911 13.1397 9.96977 13.2804C10.1104 13.421 10.3012 13.5 10.5001 13.5ZM7.50009 13.5C7.69901 13.5 7.88977 13.421 8.03042 13.2804C8.17108 13.1397 8.25009 12.949 8.25009 12.75V9.75004C8.25009 9.55113 8.17108 9.36036 8.03042 9.21971C7.88977 9.07906 7.69901 9.00004 7.50009 9.00004C7.30118 9.00004 7.11042 9.07906 6.96976 9.21971C6.82911 9.36036 6.75009 9.55113 6.75009 9.75004V12.75C6.75009 12.949 6.82911 13.1397 6.96976 13.2804C7.11042 13.421 7.30118 13.5 7.50009 13.5Z" fill="#A5AABE"/><rect x="2.625" y="4.125" width="12.75" height="0.75" rx="0.375" stroke="#A5AABE" stroke-width="0.75"/><path d="M12 3.75V2.5C12 1.94772 11.5523 1.5 11 1.5H7C6.44772 1.5 6 1.94772 6 2.5V3.75" stroke="#A5AABE" stroke-width="2"/></svg></button></div><div class="autowebinar_last-Stap_group-item-block"><textarea class="input-t autowebinar_last-Stap_group-item-block-textarea" placeholder="введите текст" name="autowebinar-text-chat"></textarea></div></div>');
    }
});
        ...
        <div class="create-resume-form_container">
                ...
                <div class="create-resume-form_left">
                    ...
                    <ul class="create-resume-form_left-list">
                                ...
                                <li class="create-resume-form_left-list-item dd">
                                    ...
                                    <p class="create-resume-form_left-list-item-text">Сценарий</p>
                                </li>
                    </ul>
                </div>
                <!-- <button disabled class="addprogram_anket-save">Сохранить проект</button> -->
                <button style="margin-top: 20px;" disabled class="addprogram_anket-upload">Загрузить автовебинар</button>
            </div>
            <section class="create-resume-form_main">
                ...
                <div class="create-resume-form_main_staps Stap3">
                    <div class="create-resume-form_main_container">
                        <h2 class="create-resume-form_main-title">3. Настройки автовебинара</h2>
                        <?= Html::beginForm('', '', ['class' => 'addprogram_anket-course-form-3', 'id' => 'addprogram_anket-course-form-3']) ?>
                            <h3 class="create-module-task-stt">Обязательно</h3>
                                    ...
                                    <div class="autowebinar-open-before-time">
                                        <select class="MyOrders_filter-select" name="autowebinar-date-reliase">
                                            <option selected class="sendActive" value="по расписанию">по расписанию</option>
                                            <option class="sendActive" value="в указанные даты">в указанные даты</option>
                                        </select>
                                    </div>
                                    <div class="autowebinar-days-type_gr-1">
                                        <div class="autowebinar-days-time_group">
                                            <div class="autowebinar-days-time_group-item">
                                                <p class="autowebinar-days-time_group-item-text">Пн</p>
                                                <input class="input-date-t input-date-time input-date-time-sh" type="time" name="autowebinar-time">
                                            </div>
                                            <div class="autowebinar-days-time_group-item">
                                                <p class="autowebinar-days-time_group-item-text">Вт</p>
                                                <input class="input-date-t input-date-time input-date-time-sh" type="time" name="autowebinar-time">
                                            </div>
                                            <div class="autowebinar-days-time_group-item">
                                                <p class="autowebinar-days-time_group-item-text">Ср</p>
                                                <input class="input-date-t input-date-time input-date-time-sh" type="time" name="autowebinar-time">
                                            </div>
                                            <div class="autowebinar-days-time_group-item">
                                                <p class="autowebinar-days-time_group-item-text">Чт</p>
                                                <input class="input-date-t input-date-time input-date-time-sh" type="time" name="autowebinar-time">
                                            </div>
                                            <div class="autowebinar-days-time_group-item">
                                                <p class="autowebinar-days-time_group-item-text">Пт</p>
                                                <input class="input-date-t input-date-time input-date-time-sh" type="time" name="autowebinar-time">
                                            </div>
                                            <div class="autowebinar-days-time_group-item">
                                                <p class="autowebinar-days-time_group-item-text">Сб</p>
                                                <input class="input-date-t input-date-time input-date-time-sh" type="time" name="autowebinar-time">
                                            </div>
                                            <div class="autowebinar-days-time_group-item">
                                                <p class="autowebinar-days-time_group-item-text">Вс</p>
                                                <input class="input-date-t input-date-time input-date-time-sh" type="time" name="autowebinar-time">
                                            </div>
                                        </div>
                                        <h4 class="create-resume-form_main-second-title">Укажите дату, до которой хотите повторять вебинар</h4>
                                        <div class="webinar-date-inputs-row">
                                            <input class="input-date-t input-date-date" type="date" name="autowebinar-date">
                                        </div>
                                    </div>
                                    <div class="autowebinar-days-type_gr-2">
                                        <div class="autowebinar-date-inputs-rows-g">
                                            <div class="webinar-date-inputs-row">
                                                <input class="input-date-t input-date-date" type="date" name="autowebinar-date">
                                                <input class="input-date-t input-date-time" type="time" name="webinar-time">
                                            </div>
                                        </div>
                                        <button type="button" class="btn--prpl-w-plus autowebinar-days-type_gr-2-btn">
                                    ...
                                    <h4 class="create-resume-form_main-second-title">Видео трансляции <br> <span>прикрепите ссылку на видео</span></h4>
                                    <input style="margin-bottom: 36px;" placeholder="введите ссылку на видео" type="text" name="autowebinar-video-link" class="input-t create-resume-form-input-t">
                ...
                <div class="create-resume-form_main_staps Stap5">
                    <div class="create-resume-form_main_container">
                        ...
                        <div style="margin-top: 36px;" class="create-resume-form_main_btns">
                            <button class="btn--purple btn--next">
                                Далее  ➜
                            </button>
                        </div>
                    </div>
                ...
                <div class="create-resume-form_main_staps Stap6">
                    <div class="create-resume-form_main_container">
                        <?= Html::beginForm('', 'post', ['class' => 'addprogram_anket-course-form-5', 'id' => 'addprogram_anket-course-form-5']) ?>
                            <h2 class="create-resume-form_main-title">6. Сценарий</h2>
                            <p class="create-resume-form5_main-text">Вы можете добавить или убрать блоки и события в сценарий автовебинара</p>  

                            <div class="webinar-date-inputs-row">
                                <select class="MyOrders_filter-select" name="autowebinar-event-type">
                                    <option selected class="sendActive" value="Презентация">Презентация</option>
                                    <option class="sendActive" value="Продающий блок">Продающий блок</option>
                                    <option class="sendActive" value="Сообщение в чат">Сообщение в чат</option>
                                </select>
                                <button type="button" class="btn--prpl-w-plus autowebinar-btn--add-script">
                            ...
                            <div class="autowebinar_last-Stap_group">
                                <div class="autowebinar_last-Stap_group-item autowebinar_last-Stap_group-item-start">
                                    <input value="00:00" class="input-date-t input-date-time input-date-time-sh input-date-time-bn" type="time" name="autowebinar-time">
                                    <p class="autowebinar_last-Stap_group-item-start-t">Начало трасляции</p>
                                </div>
                                <div class="autowebinar_last-Stap_group-2"></div>
                                <div class="autowebinar_last-Stap_group-item autowebinar_last-Stap_group-item-end">
                                    <div class="autowebinar_last-Stap_group-item-top">
                                        <input value="00:00" class="input-date-t input-date-time input-date-time-sh input-date-time-bn" type="time" name="autowebinar-time">
                                        <button type="button" class="autowebinar_last-Stap_group-item-btn">
                                            <span class="autowebinar_last-Stap_group-item-start-t">Завершение вебинара</span>
                                    ...
                                    <div class="autowebinar_last-Stap_group-item-block">
                                        <p class="autowebinar_last-Stap_group-item-block-text">Страница, на которую перейдут участники после вебинара</p>
                                        <input style="margin-bottom: 0px;" placeholder="введите ссылку" type="text" name="autowebinar-after-link" class="input-t create-resume-form-input-t">
                                    </div>
                                </div>
                            </div>
    
                            <div class="create-resume-form_main_btns">
                                <button type="submit" class="btn--purple " type="button">Сохранить сценарий</button>
                            </div>
                        <?= Html::endForm(); ?>
                    </div>
                </div>
