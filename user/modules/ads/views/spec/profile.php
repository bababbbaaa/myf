                        ...
                        <div id="item1" class="prof__item active">
                            ...
                            <div class="prof__item-inner">
                                <div class="prof__info">
                                    ...
                                    <p class="prof__info-text">
                                        Эту информацию о вас будут видеть исполнители
                                    </p>
                                    <div class="input__wrapper">
                                        <input name="photo" type="file"  id="input__file-3-2" class="input input__file">
                                        <label for="input__file-3-2" class="input__file-button">
                                            <span class="input__file-button-text">Загрузить фото</span>
                                        </label>
                                    </div>
                                </div>
                                <textarea style="min-height: 100px;" class="input-t" name="" placeholder="Расскажите о деятельности своей или компании, которую вы представляете"></textarea>
                            </div>
                            <div class="prof__item-inner">
                                <div class="prof__info">
                                    <h2 class="prof__info-title">
                                    ...
                                    <p class="prof__info-text">
                                    Обязательная информация для загрузки формирования договора оферты
                                    </p>
                                </div>
                                <label class="prof__label">
                                    <span class="prof__span">Серия и номер</span>
                                    <input class="prof__inp1 readonly__class" <?= !empty($client) ? 'readonly' : '' ?>
                                           type="text" name="" value="" placeholder="---- ------">
                                </label>
                                <label class="prof__label">
                                    <span class="prof__span">Кем выдан</span>
                                    <input class="prof__inp1 readonly__class" <?= !empty($client) ? 'readonly' : '' ?>
                                           type="text" name="" value="" placeholder="Отделом УФМС ">
                                </label>
                                <label class="prof__label">
                                    <span class="prof__span">Дата выдачи</span>
                                    <input class="prof__inp1 readonly__class" <?= !empty($client) ? 'readonly' : '' ?>
                                           type="text" name="" value="" placeholder="__.__.____">
                                </label>
                                <label class="prof__label">
                                    <span class="prof__span">Код подразделения</span>
                                    <input class="prof__inp1 readonly__class" <?= !empty($client) ? 'readonly' : '' ?>
                                           type="text" name="" value="" placeholder="---">
                                </label>
                                <label class="prof__label">
                                    <span class="prof__span">Адрес места регистрации</span>
                                    <input class="prof__inp1 readonly__class" <?= !empty($client) ? 'readonly' : '' ?>
                                           type="text" name="" value="" placeholder="Москва улица Ленина 13/2">
                                </label>
                            </div>
                          ...
                          <span class="prof__span readonly__class prof__span--2 prof__span--rec">Адрес регистрации по
                            паспорту</span>
                                ...
                                <div class="prof__info">
                                    ...
                                    <p class="prof__info-text">
                                    Не обязательна для заполнения, но повысит привлекательность ваших заказов
                                    </p>
                                </div>
                                <label class="prof__label">
                                    <span class="prof__span">Веб-сайт компании</span>
                                    <input class="prof__inp1 readonly__class" <?= !empty($client) ? 'readonly' : '' ?>
                                           type="text" name="" value="" placeholder="Ссылка на сайт">
                                </label>
                                <label class="prof__label">
                                    <span class="prof__span">Сфера деятельности</span>
                                    <input class="prof__inp1 readonly__class" <?= !empty($client) ? 'readonly' : '' ?>
                                           type="text" name="" value="" placeholder="Выбрать сферу">
                                </label>
                            </div>
                                ...
                                <div class="not__inner">
                                    <div class="not__item">
                                        ...
                                        <input id="not-email-3" <?= $prop['status'] == 1 ? 'checked' : '' ?>
                                               ...
                                               value="Изменение статуса проекта" type="checkbox"
