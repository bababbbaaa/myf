...
$('.submit-pay-fiz').on('click', function(e) {
    var value = parseFloat($('.InputDonateAmount').val()),
        hash = "$userHash",
        err = [],
    ...
    if (err.length > 0) {
        ...
        $.ajax({
            ...
            dataType: "JSON",
            type: "POST",
            url: "/skill/teacher/create-balance-link"
...
<section class="rightInfo">
    <div class="balance">
        ...
        <div class="title_row">
            ...
            <a href="<?= Url::to(['manual']) ?>">Как пополнить баланс?</a>
        </div>
        ...
        <article class="MainInfo">
            <nav class="ChangePageBalance df">
                ...
                <div class="ChangePage-Item df jcsb aic">
                    <a href="#page5" class="HText ChangePage-Item-t ChangePage-Item-t5 uscp">Акты выполненных работ</a>
                ...
                <div class="Page1-B_info df fdc">
                    ...
                    <div class="Page1-B_info-balance df aic" style="max-width: unset; padding: 0; margin-bottom: 52px; background: unset">
                        <div style="padding: 24px 28px;   width: auto;   background: #f0f1f8;   border-radius: 12px;    ">
                            <p class="Page1-nubBal purple">
                                <?= number_format($real_user->budget, 1, ',', ' ') ?><span class="Page1-numbalval purple">₽</span>
                            </p>
                        </div>

                        <div class="Page1-B_info-balance-right">
                            <p class="Page1-B_info-balance-right-ttl">Комиссия сервиса составляет - 10% от указанного бюджета заказа. Комиссию необходимо оплатить перед началом выполнения заказа</p>
                            <p class="Page1-B_info-balance-right-text">Средства будут переведены на счет исполнителя сразу после оплаты, но вывести средства исполнитель сможет только после подтверждения вами выполнения заказа. <br> В случае невыполнения заказа исполнителем, средства будут возвращены на ваш баланс</p>
                        </div>
                    </div>
                    ...
                    <div class="PopapDBC">
                        ...
                        <div class="PopapDBC-Cont df fdc aic">
                            ...
                            <div class="PopapDBC-Form df fdc">
                                ...
                                <input class="InputDonateAmount" required placeholder="Минимальная сумма пополнения 5 000₽" type="number" min="5000" name="DonateAmount" id="">
                                ...
                                <button class="btn--purple PopapDBC_Form-BTN BText df jcc aic uscp submit-pay-fiz" type="submit">Продолжить
                                </button>
                    ...
                    <div class="PopapDCD">
                        ...
                        <div class="PopapDBC-Cont df fdc aic">
                            ...
                            <div class="PopapDBC-Form df fdc">
                                ...
                                <div class="errors-block"></div>
                                <button class="btn--purple PopapDBC_Form-BTN BText df jcc aic uscp submit-pay-jur" type="submit">Продолжить
                                </button>
                                <button class="PopapDBC_Form-Reset BText df jcc aic uscp" type="reset">Отмена</button>
                            </div>
                            <?= Html::endForm(); ?>
                    ...
                    <div class="PopapDCD-Error">
                        ...
                        <div class="PopapDBC-Cont df fdc aic">
                            ...
                            <h3 class="PopapDCD2-subttl">Для оплаты по счету вам необходимо заполнить свои реквизиты в
                                профиле</h3>
                            <p class="btn--purple PopapDCD-Error_Form-BTN BText df jcc aic uscp">Перейти к заполнению</p>
            ...
            <section id="page2" class="Page-Balance Page2-Balance">
                <div class="Page2-Balance_chooseP df fdc">
                    ...
                    <div class="Page2-Balance_chooseP-P df">
                        ...
                        <button type="submit" class="btn--purple uscp Page2-Balance_chooseP-BTN df aic jcc">
                            Показать
                        </button>
            ...
            <section id="page3" class="Page-Balance Page3-Balance">
                <div class="Page2-Balance_chooseP df fdc">
                    ...
                    <div class="Page2-Balance_chooseP-P df">
                        ...
                        <button type="submit" class="btn--purple uscp Page2-Balance_chooseP-BTN2 df aic jcc">
                            Показать
                        </button>
                        <button type="button" class="reset__btns">&times;</button>
                    </div>
                    ...
                    <?php if (!empty($balance)) : ?>
                        <?php foreach ($balance as $item) : ?>
                            <div class="Page2-Balance_Row df jcsb">
                                ...
                                <a href="" class="link--purple">Скачать</a>
                            </div>
                        <?php endforeach; ?>
                    <?php else : ?>
                        <div class="Page2-Balance_Row df jcsb" style="color: #9e9e9e">Акты не найдены</div>
                    <?php endif; ?>
                </div>
                <?php if (!empty($pages)) : ?>
                    <?php echo LinkPager::widget([
