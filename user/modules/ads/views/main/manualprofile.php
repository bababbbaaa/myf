...
<section class="rightInfo">
    ...
    <section class="usermanualmain_info">
        <div class="usermanualmain_info_row">
            <img src="<?= Url::to(['/img/afo/profile-1.png']) ?>" alt="скриншот страницы">
        ...
        <div class="usermanualmain_info_column-wrapp">
            ...
            <div class="usermanualmain_info_column">
                ...
                В пункте «Контактные данные» показаны ваши контакты с регистрации, если они поменялись — можете их сменить. Не забудьте добавить почту, на нее будут присылаться акты выполненных работ и оповещения о начале и окончании работы над заказом.
                </p>
                <img src="<?= Url::to(['/img/afo/profile-2.png']) ?>" alt="скриншот страницы">
            </div>
            <div class="usermanualmain_info_column">
                <p class="usermanualmain_info_column-text">
                В пункте «О вас» вы можете добавить фото и написать о вашей деятельности. Эту информацию будут видеть исполнители
                </p>
                <img src="<?= Url::to(['/img/afo/profile-3.png']) ?>" alt="скриншот страницы">
            </div>
            <div class="usermanualmain_info_column">
                <p class="usermanualmain_info_column-text">
                Также необходимо заполнить паспортные данные для формирования договора-оферты и возможности оплачивать заказы
                </p>
                <img src="<?= Url::to(['/img/afo/profile-4.png']) ?>" alt="скриншот страницы">
            </div>
            <div class="usermanualmain_info_column">
                <p class="usermanualmain_info_column-text">
                ...
                <img src="<?= Url::to(['/img/afo/profile-5.png']) ?>" alt="скриншот страницы">
            </div>
            <div class="usermanualmain_info_column">
                <p class="usermanualmain_info_column-text">
                Не забудьте сохранить изменения!
                </p>
                <img src="<?= Url::to(['/img/afo/profile-6.png']) ?>" alt="скриншот страницы">
            </div>
            <div class="usermanualmain_info_column">
                <h3 class="usermanualmain_info_column-title">
                ...
                <img src="<?= Url::to(['/img/afo/profile-7.png']) ?>" alt="скриншот страницы">
            </div>
            <div class="usermanualmain_info_column">
                <p class="usermanualmain_info_column-text">
                ...
                <img src="<?= Url::to(['/img/afo/profile-8.png']) ?>" alt="скриншот страницы">
            </div>
            <div class="usermanualmain_info_column">
                <h3 class="usermanualmain_info_column-title">
                    3. Сменить пароль
                ...
                <img src="<?= Url::to(['/img/afo/profile-9.png']) ?>" alt="скриншот страницы">
            </div>
        </div>
    </section>
