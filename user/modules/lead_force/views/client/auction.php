...
<section class="rightInfo">
    <div class="order">
        ...
        <div class="order__top-inner">
            ...
            <a href="<?= Url::to(['usermanualauction']) ?>" class="order__top-link link">Что такое аукцион лидов?</a>
        </div>
        ...
        <div class="auction__content">
            <div class="auction__content-item auction__content-item--1 active">
                ...
                <div class="MyOrders_filter">
                    ...
                    <label class="MyOrders_filter-check-l aucFilt <?= !empty($_GET['filter']['new']) ? 'activeCheck' : '' ?>"
                           for="MyOrders_filter-check" style="font-size: 14px">Новые</label>
                </div>
                <?= Html::endForm(); ?>
                            ...
                            <div class="auction__card card-a">
                                <div class="card-a__top">
                                    ...
                                    <div class="card-a__top-item card-a__top-item--2">
                                        ...
                                        <button type="button" class="card-a__link link buy-lead-link"
                                                data-id="<?= $item['id'] ?>"
                                                data-hash="<?= md5("{$item['id']}::auc-09_buy") ?>">Купить лид
                                        </button>
                                    </div>
                                </div>
                ...
                <div class="auction__lids">
                    <div class="auction__lids-nav">
                        ...
                        <div class="order-page_leads_filter adAucFilt">
                            <input placeholder="Ключевое слово" autocomplete="off" value="<?= $_GET['filtersBy']['word'] ?>" class="InputSearch adFiltAudDate" type="text"
                                   name="filtersBy[word]">
...
//                            'value' => Html::encode($_GET['filters']['last']),
                            ...
                            <button style="font-size: 14px" type="submit"
                                    class="uscp Page2-Balance_chooseP-BTN df aic jcc order-page_leads_filterBTN">
                                Показать
                            </button>
                        </div>
                        <?= Html::endForm(); ?>
