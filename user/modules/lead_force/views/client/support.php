    ...
    <div class="support">
        ...
        <?php else: ?>
            <div class="helpDesk">
                        ...
                        <?php foreach ($dialog->messages as $k => $v): ?>
                            <?php if ($v->isSupport === 1): ?>
                                <div class="helpDesk__body-helper">
                                    ...
                                    <hr>
                                    <p class="info__text">
                                        Администратор, <?= date('d.m.Y H:i', strtotime($v->date)) ?></p>
                                </div>
                            <?php else: ?>
                ...
                <input autocomplete="off" class="helpDesk__form-input" type="text" name="message"
                       placeholder="Введите текст сообщения">
                <button class="helpDesk__form-button"><img class="helpDesk__form-image"
                                                           src="<?= Url::to(['/img/bird.png']) ?>" alt="send"></button>
                <?= Html::endForm(); ?>
            </div>
        <?php endif; ?>
        <?php Pjax::end() ?>
