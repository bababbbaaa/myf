...
<section class="rightInfo">
    <div class="balance">
        ...
        <div class="title_row">
            ...
            <a href="<?= Url::to(['usermanual']) ?>">Как пополнить баланс?</a>
        </div>
                    ...
                    <div class="PopapDBC">
                        ...
                        <div class="PopapDBC-Cont df fdc aic">
                            ...
                            <div class="PopapDBC-Form df fdc">
                                ...
                                <button class="PopapDBC_Form-BTN BText df jcc aic uscp submit-pay-fiz" type="submit">Продолжить
                                </button>
                        ...
                        <?php foreach($bills as $item): ?>
                            <div class="Page2-Balance_Row df jcsb">
                                ...
                                <div class="df fdc Page2-Balance_Row_R">
                                    <h2 class="Page2-Balance_Row-money2"><?= number_format($item['value'], '2', ',', ' ') ?> руб.</h2>
                                    <a href="<?= Url::to(['get-locale-file', 'id' => $item['id'], 'type' => 'bill']) ?>" data-pjax="0" class="HText Page2-Balance_Row-download">Скачать</a>
                                </div>
                            </div>
                        <?php endforeach; ?>
                    <?php else: ?>
                        ...
                        <?php foreach($acts as $item): ?>
                            <div class="Page2-Balance_Row df jcsb">
                                ...
                                <div class="df fdc aic Page2-Balance_Row_R2">
                                    <a href="<?= Url::to(['get-locale-file', 'id' => $item['id'], 'type' => 'act']) ?>" data-pjax="0" class="HText Page2-Balance_Row-download2">Скачать</a>
                                </div>
                            </div>
                        <?php endforeach; ?>
                    <?php else: ?>
