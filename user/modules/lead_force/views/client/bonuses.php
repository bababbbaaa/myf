        ...
        <article class="MainInfo">
            <nav class="ChangePageBalance df">
                <div class="ChangePage-Item df jcsb aic">
                    <a href="#page1" class="HText ChangePage-Item-t ChangePage-Item-t1 uscp CIT-active">Кэшбек</a>
                    <div class="ChangePage-Item-line ChangePage-Item-line1 CIL-active"></div>
                </div>
                <div class="ChangePage-Item df jcsb aic">
                    <a href="#page2" class="HText ChangePage-Item-t ChangePage-Item-t2 uscp">Бонусные материалы</a>
            ...
            <section id="page1" class="cashback Page-Bonuses Page1-Bonuses change__section active">
                <div class="cashback__body">
                    <div class="cashback__block">
                        <h2 class="cashback__block-title">Кэшбек</h2>
                        <?php if (!empty($bonuses)): ?>
                            <div class="cashback__block-persent">
                                <?= $bonuses->cashback ?><span>%</span>
                            </div>
                        <?php endif; ?>
                        <p class="cashback__block-subtitle"><?= $info['info'] ?></p>
                    </div>
                    <div class="cashback__image">
                        <img src="<?= Url::to(['/img/cashback.png']) ?>" alt="">
                    </div>
                </div>
            </section>
            <section id="page2" class="materials Page-Bonuses Page2-Bonuses change__section">
                <div class="materials__body">
                            ...
                            <?php if (!empty($info['material'])): ?>
                                <?php if (in_array('script', $info['material'])): ?>
                                    <div class="materials__block-content">
                                        <svg class="materials__content-image" width="20" height="20" viewBox="0 0 20 20"
                                            ...
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                  ...
                                                  fill="#278940"/>
                                            <path d="M5.83536 9.87105C5.54673 9.53518 5.04533 9.50115 4.71546 9.79503C4.38558 10.0889 4.35216 10.5994 4.6408 10.9353L7.41857 14.1676C7.72682 14.5263 8.27144 14.5368 8.59285 14.1903L15.3389 6.91762C15.6398 6.59316 15.6255 6.08172 15.3068 5.77528C14.9882 5.46885 14.4859 5.48346 14.1849 5.80792L8.03827 12.4344L5.83536 9.87105Z"
                                                  fill="#278940"/>
                                        </svg>
                                        <div>
                                ...
                                <?php if (in_array('personal_assistant', $info['material'])): ?>
                                    <div class="materials__block-content">
                                        ...
                                        <div>
                                            ...
                                            <a href="<?= Url::to(['support']) ?>" style="max-width: fit-content"
                                               class="confirm_btn">Связаться с
                                                маркетологом
                                            </a>
                                        </div>
                                    </div>
                                <?php endif; ?>
                            <?php else: ?>
                                <p class="cashback__block-subtitle">Закажите 70 лидов и получите Скрипт для эффективной
                                    обработки лидов</p>
                            <?php endif; ?>
                        <?php else: ?>
                            <p class="cashback__block-subtitle">Закажите 70 лидов и получите Скрипт для эффективной
                    ...
                    <div class="materials__image">
                        <img src="<?= Url::to(['/img/materials-image.png']) ?>" alt="">
                    </div>
                </div>
            </section>
            <section id="page3" class="clubCart Page-Bonuses Page3-Bonuses change__section">
                    ...
                    <?php if (empty($bonuses) || $bonuses->additional_waste == 0): ?>
                        ...
                        <div class="green__blockCard">
                            ...
                            <div class="flex__li--blok">
                                ...
                                <p>Оплачивайте услуги компании до 50% от бонусного счета</p>
                            </div>
                            <div class="flex__li--blok">
                                <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                          d="M18 9C18 13.9706 13.9706 18 9 18C4.02944 18 0 13.9706 0 9C0 4.02944 4.02944 0 9 0C13.9706 0 18 4.02944 18 9ZM1.38477 9.00033C1.38477 13.2062 4.79429 16.6157 9.00015 16.6157C13.206 16.6157 16.6155 13.2062 16.6155 9.00033C16.6155 4.79447 13.206 1.38495 9.00015 1.38495C4.79429 1.38495 1.38477 4.79447 1.38477 9.00033Z"
                                          fill="white"/>
                                    <path d="M5.25184 8.88472C4.99206 8.58244 4.u54081 8.55181 4.24392 8.81631C3.94704 9.0808 3.91695 9.54027 4.17673 9.84255L6.67673 12.7516C6.95415 13.0745 7.44431 13.0839 7.73358 12.7721L13.805 6.22664C14.0759 5.93462 14.063 5.47433 13.7762 5.19854C13.4894 4.92275 13.0373 4.9359 12.7664 5.22791L7.23446 11.1918L5.25184 8.88472Z"
                                          fill="white"/>
                                </svg>
                ...
                <div class="spendBalls">
                    ...
                    <p class="spendBalls__subtitle"></p>
