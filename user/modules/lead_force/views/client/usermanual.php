    ...
    <main class="usermanual_info">
      <section class="usermanual_info_questions">
        ...
        <nav class="usermanual_info_questions_links">
          ...
          <a class="usermanual_info_questions_link" href="<?= Url::to(['usermanualbalance']) ?>">
            Как пополнить баланс?
          </a>
          <a class="usermanual_info_questions_link" href="<?= Url::to(['usermanualauction']) ?>">
            Как купить лиды?
          </a>
          <a class="usermanual_info_questions_link" href="<?= Url::to(['usermanualmyorders']) ?>">
            Как сделать заказ?
          </a>
        ...
        <div class="usermanual_feature-list_cards">
          ...
          <div class="usermanual_feature-list_card">
            ...
            <div class="usermanual_feature-list_card_info">
              ...
              <a class="usermanual_feature-list_card_info-link" href="<?= Url::to(['usermanualbalance']) ?>">
                Читать
              </a>
            </div>
          </div>
          <div class="usermanual_feature-list_card">
            ...
            <div class="usermanual_feature-list_card_info">
              ...
              <a class="usermanual_feature-list_card_info-link" href="<?= Url::to(['usermanualmyorders']) ?>">
                Читать
              </a>
            </div>
          </div>
          ...
          <div class="usermanual_feature-list_card">
            ...
            <div class="usermanual_feature-list_card_info">
              ...
              <a class="usermanual_feature-list_card_info-link" href="<?= Url::to(['usermanualauction']) ?>">
                Читать
              </a>
            </div>
          </div>
