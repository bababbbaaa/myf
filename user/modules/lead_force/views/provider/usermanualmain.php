...
<section class="rightInfo">
  ...
  <section class="usermanualmain_info">
    <div class="usermanualmain_info_row">
      <img src="<?= Url::to(['/img/provider/Main_Image.png']) ?>" alt="скриншот страницы">
    ...
    <div class="usermanualmain_info_column-wrapp">
      ...
      <div class="usermanualmain_info_column">
        ...
        <p class="usermanualmain_info_column-text">Важные сообщения всегда будут в самой верхней части страницы, обычно это уведомления о статусах взятого в работу оффера, новых правилах или системные предупреждения.<br>
            В верхнем меню есть иконка колокольчика — там будут оповещения от тех.поддержки.</p>
        <img src="<?= Url::to(['/img/provider/notice__image.png']) ?>" alt="скриншот страницы">
      </div>
        <a id="balance"></a>
      <div class="usermanualmain_info_column">
        <h3 class="usermanualmain_info_column-title">
        ...
        <p class="usermanualmain_info_column-text">
            С главной страницы вы можете сразу перейти к получение средств

        </p>
        <img src="<?= Url::to(['/img/provider/balance__image.png']) ?>" alt="скриншот страницы">
      </div>
<!--      <div class="usermanualmain_info_column">-->
<!--        <p class="usermanualmain_info_column-text">-->
