...
$js = <<<JS
    ...
    var gets = (new URL(document.location)).searchParams; 
    var getsParams = gets.get("template");
    var count = 1;
    var timeout = setTimeout(function() {
      $.pjax.reload({
        url: 'order-lid?template=' + getsParams,
        data: {count: count},
        type: 'GET',
...
<section class="rightInfo">
    ...
    <div class="order-lid">
        <div class="bcr">
            <ul class="bcr__list">
                <li class="bcr__item">
                    <a href="<?= Url::to(['promotion']) ?>" class="bcr__link">
                        Создать заказ
                    </a>
                </li>
                <li class="bcr__item">
            ...
            <div class="order-lid__step1 step">
                <div class="order-lid__inner">
                    ...
                    <div class="order-lid__main">
                        ...
                        <input type="number" id="leads__count" step="5" min="10" name="lead_count" value="50" placeholder="Например, 50"
                    ...
                    <div class="popup__body">
                        <div class="popup__lid">
                            ...
                            <p class="popup__lid-text">
                                ...
                                меню <a href="<?= Url::to(['promotion']) ?>" class="link">мои рекламные компании</a>
                            </p>

                            <a href="<?= Url::to(['promotion']) ?>" class="popup__lid-btn btn">
                                Продолжить
                            </a>
                        </div>
