...
$('.submit-pay-fiz').on('click', function(e) {
    var value = parseFloat($('#FizPay').val()),
        hash = "$userHash",
        err = [],
      ...
      <section id="page1" class="Page-Balance Page1-Balance active">
        <div class="Page1-B_info df fdc">
          ...
          <div style="display: flex; flex-direction: column; gap: 20px" class="">
            ...
            <input style="max-width: 400px" name="price" id="priceCheck" class="InputDonateAmount" placeholder="Укажите сумму пополнения" type="number">
          ...
          <div class="PopapDBC">
            ...
            <div class="PopapDBC-Cont df fdc aic">
              ...
              <div class="PopapDBC-Form df fdc">
                ...
                <input class="InputDonateAmount" required placeholder="Минимальная сумма пополнения 5 000₽" type="number" min="5000" name="DonateAmount" id="FizPay">
