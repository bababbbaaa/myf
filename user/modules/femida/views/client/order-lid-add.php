          ...
          <span class="bcr__span">
            Создание индивидуального заказа
                ...
                <div class="order-lid__add">
                    ...
                    <input type="hidden" value="<?= str_replace('"', "", $_GET['f']) ?>" name="franchize">
                    <input type="hidden" value="<?= str_replace('"', "", $_GET['id']) ?>" name="pack_id">
                            ...
                            <div class="popup__body">
                                <div class="popup__lid">
                                    ...
                                    <p class="popup__lid-text">
                                        ...
                                        пункте
                                        меню <a href="<?= Url::to(['promotion', '#' => 2]) ?>" class="link">Мои рекламные компании</a>
                                    </p>

                                    <a href="<?= Url::to(['myfranchize']) ?>" class="popup__lid-btn btn">
                                        Продолжить
                                    </a>
                                </div>
