    ...
    <div class="cab__main">
      <?php if (!ClientController::fullInfo($client)) : ?>
        <div class="mass mass--cab">
          <div class="mass__content mass__content--cab">
            ...
            <a href="<?= Url::to(['profile']) ?>" class="mass__link btn">
              Перейти в профиль
            </a>
      ...
      <!-- <div class="mass mass--prov">
            <div class="mass__content mass__content--prov">
              ...
              <button style="color: #a3ccf4;" data-id="<?= $v->id ?>" type="button" class="mass__close mass__close--prov">&times;
              </button>
            </div>
          </div> -->
      <!-- <//?php else : ?> -->
      <!-- <div class="mass mass--zak">
            <div class="mass__content mass__content--zak">
              ...
              <button style="color: #FFA800" data-id="<?= $v->id ?>" type="button" class="mass__close mass__close--zak">&times;
              </button>
            </div>
          </div> -->
      <!-- <//?php endif; ?> -->
      ...
      <div class="popup__body">
        <div class="popup__content-1">
          <div class="popup__text">
            ...
            <a href="<?= Url::to(['profile']) ?>" class="link popup__link">
