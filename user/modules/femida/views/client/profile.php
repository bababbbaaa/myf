          ...
          type: 'POST',
            ...
            if (response.status === 'error') {
                ...
                $('.errors__texts2').html(text);
                 ...
                 $.pjax.reload({container: '#PjaxCont'});
                  $('.popup--w2').fadeOut(300);
                    $('body').css({"overflow": "auto"});
            }
        });
    });
...
<section class="rightInfo">
  <div class="cab__wrapp">
    <div class="prof__main">
      ...
      <h1 class="prof__title title-main">
        Профиль
      </h1>
            ...
            <div id="item1" class="prof__item active">
              <div class="prof__item-inner">
                ...
                <label class="prof__label">
                  ...
                  <input class="prof__inp1 readonly__class" <?= !empty($client) ? 'readonly' : '' ?> type="text" name="fields[familiya]" value="<?= $client['f'] ?? '' ?>" placeholder="Фамилия">
                </label>
                <label class="prof__label">
                  <span class="prof__span">Ваше имя</span>
                  <input class="prof__inp1 readonly__class" <?= !empty($client) ? 'readonly' : '' ?> value="<?= $client['i'] ?? '' ?>" type="text" name="fields[imya]" placeholder="Имя">
                </label>
                <label class="prof__label">
                  <span class="prof__span">Ваше отчество</span>
                  <input class="prof__inp1 readonly__class" <?= !empty($client) ? 'readonly' : '' ?> value="<?= $client['o'] ?? '' ?>" type="text" name="fields[otchestvo]" placeholder="Отчество">
                </label>
                <?php if (!empty($model)) : ?>
                  <label class="prof__label">
                    <span class="prof__span">Номер телефона</span>
                    <input style="user-select: none" class="prof__inp1 readonly__class" readonly type="text" name="fields[phone]" value="<?= $model['username'] ?>" placeholder="Телефон">
                  </label>
                <?php endif; ?>
                <label class="prof__label">
                  <span class="prof__span prof__span--rec">Почта</span>
                  <input class="prof__inp1 readonly__class" <?= !empty($client) ? 'readonly' : '' ?> value="<?= $client['email'] ?? '' ?>" data-type="rec" type="email" name="fields[email]" placeholder="email@mail.ru">
                </label>
              </div>
                  ...
                  <div class="prof__item-nav">
                    <?php if (!empty($company)) : ?>
                      <label class="prof__item-nav-li prof__item-nav-li--1 boxe1 active">
                        <input style="display: none" checked value="jur" id="box1" type="radio" name="fields[type]">
                        Юридическое лицо
                      </label>
                    <?php endif; ?>
                    <?php if (!empty($fiz)) : ?>
                      <label class="prof__item-nav-li prof__item-nav-li--1 boxe2 active">
                        <input style="display: none" value="fiz" id="box2" type="radio" name="fields[type]">
                        Физическое лицо
                      </label>
                    <?php endif; ?>
                  </div>
                    ...
                    <div class="prof__item-box prof__item-box--1 <?= $company ? 'active' : '' ?> box1">
                      <div class="prof__item-clm">
                        <div class="prof__item-row">
                          <label class="prof__item-label">
                            ...
                            <input <?= $company ? 'readonly' : '' ?> value="<?= $company->companyName ?>" class="prof__inp1 readonly__class prof__inp1--w" data-type="rec" type="text" name="fields[jur][companyName]" placeholder="ООО «Компания»">
                          </label>
                          <label class="prof__item-label">
                            <span class="prof__span prof__span--2 prof__span--rec">Юридический адрес</span>
                            <input <?= $company ? 'readonly' : '' ?> value="<?= $company->address_jur ?>" class="prof__inp1 readonly__class prof__inp1--w" data-type="rec" type="text" name="fields[jur][address_jur]" placeholder="Индекс, регион, город, улица, дом">
                          </label>
                        </div>
                        ...
                        <div class="prof__item-row">
                          <label class="prof__item-label">
                            ...
                            <input <?= $company ? 'readonly' : '' ?> value="<?= $company->director ?>" class="prof__inp1 readonly__class prof__inp1--w" type="text" data-type="rec" name="fields[jur][director]" placeholder="ФИО по паспорту">
                          </label>

                          <label class="prof__item-label">
                            <span class="prof__span prof__span--2 prof__span--rec">Фактический адрес</span>
                            <input <?= $company ? 'readonly' : '' ?> value="<?= $company->address_real ?>" class="prof__inp1 readonly__class prof__inp1--w prof__inp1--mb" type="text" data-type="rec" name="fields[jur][address_real]" placeholder="Индекс, регион, город, улица, дом">
                            <input id="add-copy" class="prof__checkbox-inp" checked type="checkbox" name="fields[jur][address_copy]" />
                      ...
                      <div class="prof__add">
                        <div class="prof__info">
                          ...
                          <p class="prof__info-text">
                            Не обязательна для заполнения, но повысит привлекательность
                            ваших заказов
                          </p>
                        </div>
                        ...
                        <div class="prof__form">
                          <label class="prof__label">
                            <span class="prof__span">Веб-сайт компании</span>
                            <input <?= $company ? 'readonly' : '' ?> value="<?= $company->web_site ?>" class="prof__inp1 readonly__class" type="text" name="fields[jur][web_site]" placeholder="Веб-сайт компании">
                          </label>

                          <label class="prof__label">
                            <span class="prof__span">Сфера деятельности</span>
                            <input <?= $company ? 'readonly' : '' ?> value="<?= $company->work ?>" class="prof__inp1 readonly__class" placeholder="Выбрать сферу" name="fields[jur][work]" id="work">
                          </label>
                      ...
                      <div class="prof__item-wrap">
                        <label class="prof__item-label prof__item-label--1">
                          <span class="prof__span readonly__class prof__span--2 prof__span--rec">Адрес регистрации по
                            паспорту</span>
                          <input <?= $fiz ? 'readonly' : '' ?> value="<?= $fiz->address ?>" class="prof__inp1 readonly__class prof__inp1--w" type="text" name="fields[fiz][address_registration]" data-type="rec" placeholder="Индекс, регион, город, улица, дом">
                        </label>
                        <?php if (empty($fiz)) : ?>
                          <button type="button" class="prof__add-btn1 btn__form1 btn">
                            Сохранить изменения
                    ...
                    <div class="prof__item-box prof__item-box--1 active box1">
                      <div class="prof__item-clm">
                        <div class="prof__item-row">
                          <label class="prof__item-label">
                            <span class="prof__span prof__span--2 prof__span--rec">Полное название организации</span>
                            <input class="prof__inp1 readonly__class prof__inp1--w" data-type="rec" type="text" name="fields[jur][companyName]" placeholder="ООО «Компания»">
                          </label>
                          <label class="prof__item-label">
                            <span class="prof__span prof__span--2 prof__span--rec">Юридический адрес</span>
                            <input class="prof__inp1 readonly__class prof__inp1--w" data-type="rec" type="text" name="fields[jur][address_jur]" placeholder="Индекс, регион, город, улица, дом">
                          </label>
                        </div>
                        ...
                        <div class="prof__item-row">
                          <label class="prof__item-label">
                            <span class="prof__span prof__span--2 prof__span--rec">Генеральный директор</span>
                            <input class="prof__inp1 readonly__class prof__inp1--w" type="text" data-type="rec" name="fields[jur][director]" placeholder="ФИО по паспорту">
                          </label>

                          <label class="prof__item-label">
                            <span class="prof__span prof__span--2 prof__span--rec">Фактический адрес</span>
                            <input class="prof__inp1 readonly__class prof__inp1--w prof__inp1--mb" type="text" data-type="rec" name="fields[jur][address_real]" placeholder="Индекс, регион, город, улица, дом">
                            <input id="add-copy" class="prof__checkbox-inp readonly__class" checked type="checkbox" name="fields[jur][address_copy]" />
                            <label for="add-copy" class="prof__checkbox">
                              Совпадает с юридическим
                            </label>
                          </label>
                      ...
                      <div class="prof__add">
                        ...
                        <div class="prof__form">
                          <label class="prof__label">
                            <span class="prof__span">Веб-сайт компании</span>
                            <input class="prof__inp1 readonly__class" type="text" name="fields[jur][web_site]" placeholder="Веб-сайт компании">
                          </label>

                          <label class="prof__label">
                            <span class="prof__span">Сфера деятельности</span>
                            <input class="prof__inp1 readonly__class" placeholder="Выбрать сферу" name="fields[jur][work]" id="work">
                          </label>
                      ...
                      <div class="prof__item-wrap">
                        <label class="prof__item-label prof__item-label--1">
                          <span class="prof__span prof__span--2 prof__span--rec">Адрес регистрации по
                            паспорту</span>
                          <input class="prof__inp1 readonly__class prof__inp1--w" type="text" name="fields[fiz][address_registration]" data-type="rec" placeholder="Индекс, регион, город, улица, дом">
                        </label>
              ...
              <?php if (empty($infoPay)) : ?>
                <div class="prof__mass">
                  <p class="prof__mass-content">
                    Вы можете оплачивать заказы как физическое или юридическое лицо. И создать по одному
                    плательщику
                  ...
                  <div class="prof__item-tabs prof__item-tabs--1">
                    <div class="prof__item-nav prof__item-nav--1">
                      <label class="prof__item-nav-li prof__item-nav-li--1 boxe3 active">
                        <input style="display: none" checked value="jur" id="box3" type="radio" name="info[type]">
                        Юридическое лицо
                      </label>
                      <label class="prof__item-nav-li prof__item-nav-li--1 boxe4">
                        <input style="display: none" value="fiz" id="box4" type="radio" name="info[type]">
                        Физическое лицо
                      </label>
                    </div>
                    <div class="prof__item-content">
                        ...
                        <div class="prof__item-inner">
                          ...
                          <div class="prof__form">
                            <label class="prof__label">
                              ...
                              <input value="<?= $company->companyName ?>" class="prof__inp1" type="text" name="info[jur][organization]" placeholder="ООО 'Праватон'">
                            </label>

                            <label class="prof__label">
                              <span class="prof__span">Генеральный директор</span>
                              <input value="<?= $company->director ?>" class="prof__inp1" type="text" name="info[jur][director]" placeholder="Иван Иванов">
                            </label>

                            <label class="prof__label">
                              <span class="prof__span">Юридический адрес</span>
                              <input value="<?= $company->address_jur ?>" class="prof__inp1" type="text" name="info[jur][jur_address]" placeholder="Юридический адрес">
                            </label>

                            <label class="prof__label">
                              <span class="prof__span">Фактический адрес</span>
                              <input value="<?= $company->address_real ?>" class="prof__inp1" type="text" name="info[jur][real_address]" placeholder="Фактический адрес">
                            </label>


                            <label class="prof__label">
                              <span class="prof__span">ИНН</span>
                              <input <?= !empty($infoPay['jur']['inn']) ? 'readonly' : '' ?> value="<?= $infoPay['jur']['inn'] ?? '' ?>" class="prof__inp1" type="text" name="info[jur][inn]" placeholder="10 цифр">
                            </label>
                            <label class="prof__label">
                              <span class="prof__span">ОГРН(ИП)</span>
                              <input <?= !empty($infoPay['jur']['ogrn']) ? 'readonly' : '' ?> value="<?= $infoPay['jur']['ogrn'] ?? '' ?>" class="prof__inp1" type="text" name="info[jur][ogrn]" placeholder="13 или 15 цифр">
                            </label>
                            <label class="prof__label">
                              <span class="prof__span">КПП</span>
                              <input <?= !empty($infoPay['jur']['kpp']) ? 'readonly' : '' ?> value="<?= $infoPay['jur']['kpp'] ?? '' ?>" class="prof__inp1" type="text" name="info[jur][kpp]" placeholder="9 цифр">
                            </label>
                          </div>
                        </div>
                        ...
                        <div class="prof__item-inner">
                          ...
                          <div class="prof__form">
                            <label class="prof__label">
                              ...
                              <input <?= !empty($infoPay['jur']['bank']) ? 'readonly' : '' ?> value="<?= $infoPay['jur']['bank'] ?? '' ?>" class="prof__inp1" type="text" name="info[jur][bank]" placeholder="Сбербанк России">
                            </label>
                            <label class="prof__label">
                              <span class="prof__span">БИК</span>
                              <input <?= !empty($infoPay['jur']['bik']) ? 'readonly' : '' ?> value="<?= $infoPay['jur']['bik'] ?? '' ?>" class="prof__inp1" type="text" name="info[jur][bik]" placeholder="9 цифр">
                            </label>
                            <label class="prof__label">
                              <span class="prof__span">Расчетный счет</span>
                              <input <?= !empty($infoPay['jur']['rs']) ? 'readonly' : '' ?> value="<?= $infoPay['jur']['rs'] ?? '' ?>" class="prof__inp1" type="text" name="info[jur][rs]" placeholder="20 цифр">
                            </label>
                            <label class="prof__label">
                              <span class="prof__span">Корреспондентский счет</span>
                              <input <?= !empty($infoPay['jur']['ks']) ? 'readonly' : '' ?> value="<?= $infoPay['jur']['ks'] ?? '' ?>" class="prof__inp1" type="text" name="info[jur][ks]" placeholder="20 цифр">
                            </label>
                          </div>
                        </div>
                      ...
                      <div id="box4" class="prof__item-box prof__item-box--2 box4">
                        <div class="prof__item-inner">
                          <div class="prof__info">
                            ...
                            <input checked id="prof__info-check" class="prof__checkbox-inp checkInform" type="checkbox" name="info[fiz][address-copy]" />
                            <label for="prof__info-check" class="prof__checkbox checkInformLabel">
                          ...
                          <div class="prof__form">
                            <label class="prof__label">
                              <span class="prof__span">Ваша фамилия</span>
                              <input <?= $client['f'] ? 'readonly' : '' ?> class="prof__inp1 resetInp" data-value="form5-1" value="<?= $client['f'] ?>" type="text" name="info[fiz][f]" placeholder="Фамилия">
                            </label>
                            <label class="prof__label">
                              <span class="prof__span">Ваше имя</span>
                              <input <?= $client['i'] ? 'readonly' : '' ?> class="prof__inp1 resetInp" data-value="form5-1" value="<?= $client['i'] ?>" type="text" name="info[fiz][i]" placeholder="Имя">
                            </label>
                            <label class="prof__label">
                              <span class="prof__span">Ваше отчество</span>
                              <input <?= $client['o'] ? 'readonly' : '' ?> class="prof__inp1 resetInp" data-value="form5-1" value="<?= $client['o'] ?>" type="text" name="info[fiz][o]" placeholder="Отчество">
                            </label>
                            <label class="prof__label">
                              <span class="prof__span">Адрес регистрации</span>
                              <input <?= $addressReal['fiz']['address'] ? 'readonly' : '' ?> class="prof__inp1 resetInp" data-value="form5-2" value="<?= $addressReal['fiz']['address'] ?>" type="text" name="info[fiz][address]" placeholder="Индекс, регион, город, улица, дом">
                            </label>
                            <label class="prof__label">
                              <span class="prof__span">Номер телефона</span>
                              <input <?= $client[''] ? 'readonly' : '' ?> class="prof__inp1 resetInp" data-value="form5-3" value="" type="tel" name="info[fiz][phone]" placeholder="Телефон">
                            </label>
                            <label class="prof__label">
                              <span class="prof__span">Почта</span>
                              <input <?= $client['email'] ? 'readonly' : '' ?> class="prof__inp1 resetInp" data-value="form5-4" value="<?= $client['email'] ?>" type="email" name="info[fiz][email]" placeholder="email@mail.ru">
                            </label>
                          </div>
                        </div>
                      ...
                      <div id="box6" class="prof__item-box2 prof__item-box2--2 active">
                        <div class="prof__item-inner">
                          ...
                          <div class="prof__form">
                            <label class="prof__label">
                              <span class="prof__span">Полное название организации</span>
                              <input <?= !empty($infoPay['jur']['organization']) ? 'readonly' : '' ?> value="<?= $infoPay['jur']['organization'] ?? '' ?>" class="prof__inp1" type="text" name="info[jur][organization]" placeholder="ООО 'Праватон'">
                            </label>

                            <label class="prof__label">
                              <span class="prof__span">Генеральный директор</span>
                              <input <?= !empty($infoPay['jur']['director']) ? 'readonly' : '' ?> value="<?= $infoPay['jur']['director'] ?? '' ?>" class="prof__inp1" type="text" name="info[jur][director]" placeholder="Иван Иванов">
                            </label>

                            <label class="prof__label">
                              <span class="prof__span">Юридический адрес</span>
                              <input <?= !empty($infoPay['jur']['jur_address']) ? 'readonly' : '' ?> value="<?= $infoPay['jur']['jur_address'] ?? '' ?>" class="prof__inp1" type="text" name="info[jur][jur_address]" placeholder="Юридический адрес">
                            </label>

                            <label class="prof__label">
                              <span class="prof__span">Фактический адрес</span>
                              <input <?= !empty($infoPay['jur']['real_address']) ? 'readonly' : '' ?> value="<?= $infoPay['jur']['real_address'] ?? '' ?>" class="prof__inp1" type="text" name="info[jur][real_address]" placeholder="Фактический адрес">
                            </label>
                            <label class="prof__label">
                              <span class="prof__span">ИНН</span>
                              <input <?= !empty($infoPay['jur']['inn']) ? 'readonly' : '' ?> value="<?= $infoPay['jur']['inn'] ?? '' ?>" class="prof__inp1" type="text" name="info[jur][inn]" placeholder="10 цифр">
                      ...
                      <div id="box5" class="prof__item-box2 prof__item-box2--2 active">
                        <div class="prof__item-inner">
                          ...
                          <div class="prof__form">
                            <label class="prof__label">
                              <span class="prof__span">Ваша фамилия</span>
                              <input <?= !empty($infoPay['fiz']['f']) ? 'readonly' : '' ?> value="<?= $infoPay['fiz']['f'] ?? '' ?>" class="prof__inp1 resetInp" data-value="form5-1" type="text" name="info[fiz][f]" placeholder="Фамилия">
                            </label>
                            <label class="prof__label">
                              <span class="prof__span">Ваше имя</span>
                              <input <?= !empty($infoPay['fiz']['i']) ? 'readonly' : '' ?> value="<?= $infoPay['fiz']['i'] ?? '' ?>" class="prof__inp1 resetInp" data-value="form5-1" type="text" name="info[fiz][i]" placeholder="Имя">
                            </label>
                            <label class="prof__label">
                              <span class="prof__span">Ваше отчество</span>
                              <input <?= !empty($infoPay['fiz']['o']) ? 'readonly' : '' ?> value="<?= $infoPay['fiz']['o'] ?? '' ?>" class="prof__inp1 resetInp" data-value="form5-1" type="text" name="info[fiz][o]" placeholder="Отчество">
                            </label>
                            <label class="prof__label">
                              <span class="prof__span">Адрес регистрации</span>
                              <input <?= !empty($infoPay['fiz']['address']) ? 'readonly' : '' ?> value="<?= $infoPay['fiz']['address'] ?? '' ?>" class="prof__inp1 resetInp" data-value="form5-2" type="text" name="info[fiz][address]" placeholder="Индекс, регион, город, улица, дом">
                            </label>
                            <label class="prof__label">
                              <span class="prof__span">Номер телефона</span>
                              <input <?= !empty($infoPay['fiz']['phone']) ? 'readonly' : '' ?> value="<?= $infoPay['fiz']['phone'] ?? '' ?>" class="prof__inp1 resetInp" data-value="form5-3" type="tel" name="info[fiz][phone]" placeholder="Телефон">
                            </label>
                            <label class="prof__label">
                              <span class="prof__span">Почта</span>
                              <input <?= !empty($infoPay['fiz']['email']) ? 'readonly' : '' ?> value="<?= $infoPay['fiz']['email'] ?? '' ?>" class="prof__inp1 resetInp" data-value="form5-4" type="email" name="info[fiz][email]" placeholder="email@mail.ru">
                            </label>
                          </div>
                        </div>
                      </div>
              ...
              <?php elseif (!empty($infoPay['fiz'])) : ?>
                  ...
                  <div class="prof__item-tabs prof__item-tabs--1">
                    ...
                    <div class="prof__item-content">
                      <div id="box5" class="prof__item-box2 prof__item-box2--2 active">
                        ...
                        <button type="button" class="prof__add-btn2 prof__add-btn2--1 btn add__payments--more">
                ...
                <div style="display: none" class="prof__item-step3 show__payments--more">
                  <div class="prof__item-tabs">
                    <div class="prof__item-nav">
                      <span class="prof__item-nav-li prof__item-nav-li--2 active">Юридическое лицо</span>
                      <input value="jur" type="checkbox" checked name="info[type]" style="display: none">
                    </div>
              ...
              <?php elseif (!empty($infoPay['jur'])) : ?>
                ...
                <div style="display: none" class="prof__item-step2 show__payments--more">
                  <div class="prof__item-tabs prof__item-tabs--1">
                    <div class="prof__item-nav">
                      <span class="prof__item-nav-li prof__item-nav-li--2 active">Физическое лицо</span>
                      <input value="fiz" type="checkbox" checked name="info[type]" style="display: none">
                    </div>
              ...
              <div class="prof__item-inner prof__item-inner--pass">
                <div class="prof__form prof__form--pass">
                  <label class="prof__label">
                    ...
                    <input class="prof__inp1" type="password" name="password[now]" placeholder="_____">
                  </label>

                  <label class="prof__label">
                    <span class="prof__span">Новый пароль</span>
                    <input class="prof__inp1" type="password" name="password[new]" placeholder="_____">
                  </label>

                  <label class="prof__label">
                    <span class="prof__span">Повторите новый пароль</span>
                    <input class="prof__inp1" type="password" name="password[repeat]" placeholder="_____">
                  </label>
              ...
              <div class="not">
                <div class="not__inner">
                  <div class="not__item">
                    ...
                    <input id="not-email-1" <?= $prop['email'] == 1 ? 'checked' : '' ?> class="not__chek prof__checkbox-inp" value="Новости" type="checkbox" name="propertis[email]" />
                    <label for="not-email-1" class="not__chek prof__checkbox">
                      Новости
                    </label>

                    <input id="not-email-2" <?= $prop['status'] == 1 ? 'checked' : '' ?> class="not__chek prof__checkbox-inp" value="Изменение статуса заказа" type="checkbox" name="propertis[status]" />
                    <label for="not-email-2" class="not__chek prof__checkbox">
                      Изменение статуса заказа
                    </label>

                    <input id="not-email-3" <?= $prop['balance'] == 1 ? 'checked' : '' ?> class="not__chek prof__checkbox-inp" value="Окончание средств на балансе" type="checkbox" name="propertis[balance]" />
                  ...
                  <div class="not__item">
                    ...
                    <input id="not-push-1" <?= $prop['push'] == 1 ? 'checked' : '' ?> class="not__chek prof__checkbox-inp" value="Новости" type="checkbox" name="propertis[push]" />
                    <label for="not-push-1" class="not__chek prof__checkbox">
                      Новости
                    </label>

                    <input id="not-push-2" <?= $prop['push_status'] == 1 ? 'checked' : '' ?> class="not__chek prof__checkbox-inp" value="Изменение статуса заказа" type="checkbox" name="propertis[push_status]" />
                    <label for="not-push-2" class="not__chek prof__checkbox">
                      Изменение статуса заказа
                    </label>

                    <input id="not-push-3" <?= $prop['new_lead'] == 1 ? 'checked' : '' ?> class="not__chek prof__checkbox-inp" value="Новые лиды" type="checkbox" name="propertis[new_lead]" />
                    <label for="not-push-3" class="not__chek prof__checkbox">
                      Новые лиды
                    </label>

                    <input id="not-push-4" <?= $prop['proposition'] == 1 ? 'checked' : '' ?> class="not__chek prof__checkbox-inp" value="Новые предложения лидов" type="checkbox" name="propertis[proposition]" />
                    <label for="not-push-4" class="not__chek prof__checkbox">
                      Новые предложения лидов
                    </label>
                  </div>
                </div>
    ...
    <div class="popup__ov">
      <div class="popup__body popup__body--w">
        <div class="popup__content popup__content--w">
          ...
          <p class="popup__text">
            Сохраненные данные можно редактировать только через обращение в <a href="<?= Url::to(['backing']) ?>" class="link">тех.поддержку</a>
          </p>
    ...
    <div class="popup__ov">
      <div class="popup__body popup__body--err2">
        <div class="popup__content popup__content--err">
          <p class="popup__title">Ошибка!</p>
          <p class="popup__text">
            Пароль введен неправильно. Поробуйте еще раз или обратитесь в <a href="<?= Url::to(['backing']) ?>" class="link">тех.поддержку</a>
          </p>
          <button class="popup__btn popup__btn--err btn">Закрыть</button>
        </div>
        <div class="popup__close">
