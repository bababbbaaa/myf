...
JS;
$this->registerJs($js);
$this->registerCssFile(Url::to(['/css/style.css']), ['depends' => \user\assets\FemidaAsset::className(), 'position' => \yii\web\View::POS_END]);
$this->registerCssFile(Url::to(['/css/adaptive.css']), ['depends' => \user\assets\FemidaAsset::className(), 'position' => \yii\web\View::POS_END]);
?>
