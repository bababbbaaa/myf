...
$js = <<< JS
    ...
    $('.popup__btn1').on('click', function (e) {
        e.preventDefault();
        $.ajax({
            url: 'lead-force/client/profile-saver',
    ...
    $('.send__pay-fiz').on('click', function(e) {
        e.preventDefault();
        $.ajax({
          url: 'lead-force/client/info-payment',
    ...
    $('#form4').submit(function(e) {
      e.preventDefault();
      $.ajax({
            url: 'lead-force/client/propertis',
                        ...
                        <div id="item3" class="prof__item pass">
                            <div class="prof__item-inner prof__item-inner--pass">
                                <div class="prof__form prof__form--pass">
                                    ...
                                    <button style="float: right" type="button" class="prof__add-btn31 btn">
                                        Сменить пароль
                                    </button>
                                </div>
                            </div>
