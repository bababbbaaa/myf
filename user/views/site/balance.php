...
$('.submit-pay-fiz').on('click', function(e) {
    var value = parseFloat($('#inpDonAmm').val()),
        hash = "$userHash",
        err = [],
...
if ($count > 2){
    ...
    $('.Page5-Balance_stat-ttl').text('Недостаточно данных для отображения статистики!');
}
...
<section class="rightInfo">
    <div class="balance">
        ...
        <div class="title_row">
            ...
            <a href="<?= Url::to(['/lead-force/client/usermanual']) ?>">Как пополнить баланс?</a>
        </div>

        <article class="MainInfo">
            <nav class="ChangePageBalance df">
                <div class="ChangePage-Item df jcsb aic">
                    <a href="#page1" class="HText ChangePage-Item-t ChangePage-Item-t1 uscp CIT-active">Пополнение
                        баланса</a>
                ...
                <div class="ChangePage-Item df jcsb aic">
                    <a href="#page4" class="HText ChangePage-Item-t ChangePage-Item-t4 uscp">Акты выполненных работ</a>
                    <div class="ChangePage-Item-line ChangePage-Item-line4"></div>
                </div>
                <div class="ChangePage-Item df jcsb aic">
                    <a href="#page5" class="HText ChangePage-Item-t ChangePage-Item-t5 uscp">Статистика</a>
                ...
                <div class="PopapDBCWrap">
                    <div class="PopapDBC">
                        ...
                        <div class="PopapDBC-Cont df fdc aic">
                            ...
                            <div class="PopapDBC-Form df fdc">
                                ...
                                <input id="inpDonAmm" class="InputDonateAmount" required
                                       placeholder="Минимальная сумма пополнения 5 000₽" type="number" min="5000"
                                       name="DonateAmount" id="">
                                ...
                                <button class="PopapDBC_Form-BTN BText df jcc aic uscp submit-pay-fiz" type="submit">
                                    Продолжить
                                </button>
                    ...
                    <div class="PopapDCD">
                        ...
                        <div class="PopapDBC-Cont df fdc aic">
                            ...
                            <div class="PopapDBC-Form df fdc">
                                <p class="PopapDBC-t2 HText">Сумма</p>
                                <input class="InputDonateAmount2" required
                                       placeholder="Минимальная сумма пополнения 5 000₽"
                                       type="number" min="5000" name="DonateAmount" id="">
                                <div class="CheckboxDonateandlink df aic">
                                    <input checked class="CheckboxDonate" required type="checkbox" name=""
                                           id="check_one_pay2">
                                    <p class="CheckboxDonatelink">Подтверждаю согласие с <a
                                                href="<?= Url::to(['policy']) ?>">условиями
                                            обработки данных</a></p>
                                </div>
                                <div class="errors-block"></div>
                                <button class="PopapDBC_Form-BTN BText df jcc aic uscp submit-pay-jur" type="submit">
                                    Продолжить
                                </button>
                                <button class="PopapDBC_Form-Reset BText df jcc aic uscp" type="reset">Отмена</button>
                            </div>
                ...
                <div class="Page2-Balance_Rows df fdc">
                    ...
                    <?php if (!empty($bills)): ?>
                        <?php foreach ($bills as $item): ?>
                            <div class="Page2-Balance_Row df jcsb">
                                <div class="Page2-Balance_Row_L df fdc">
                                    <p class="HText Page2-Balance_Row-name2"><?= $item['name'] ?></p>
                                    <div class="Page2-Balance_Row-subrow df">
                                ...
                                <div class="df fdc Page2-Balance_Row_R">
                                    <h2 class="Page2-Balance_Row-money2"><?= number_format($item['value'], '2', ',', ' ') ?>
                                        руб.</h2>
                                    <a href="<?= Url::to(['get-locale-file', 'id' => $item['id'], 'type' => 'bill']) ?>"
                    ...
                    <?php else: ?>
                        <div class="Page2-Balance_Row df jcsb">
                            <div class="Page2-Balance_Row_L df fdc">
                                <p class="HText Page2-Balance_Row-name2" style="color: #9e9e9e">Счета не найдены</p>
                            </div>
                        </div>
                    <?php endif; ?>
                    <div>
                ...
                <div class="Page2-Balance_Rows df fdc">
                    ...
                    <?php if (!empty($acts)): ?>
                        <?php foreach ($acts as $item): ?>
                            <div class="Page2-Balance_Row df jcsb">
                                <div class="Page2-Balance_Row_L df fdc">
                                    <p class="HText Page2-Balance_Row-name3"><?= $item['name'] ?></p>
                                    <div class="Page2-Balance_Row-subrow df">
                                ...
                                <div class="df fdc aic Page2-Balance_Row_R2">
                                    <a href="<?= Url::to(['get-locale-file', 'id' => $item['id'], 'type' => 'act']) ?>"
                    ...
                    <?php else: ?>
                        <div class="Page2-Balance_Row df jcsb">
                            <div class="Page2-Balance_Row_L df fdc">
                                <p class="HText Page2-Balance_Row-name2" style="color: #9e9e9e">Акты не найдены</p>
                            </div>
                        </div>
                    <?php endif; ?>
                    <div>
            ...
            <section id="page5" class="Page-Balance Page5-Balance">
                <div class="Page5-Balance_stat">
                    <p class="HText Page5-Balance_stat-ttl">Здесь отображается статистика движения средств на балансе
